...
class PatientController extends Controller
{
    ...
    {
        $ids = Appointment::where('practitioner_id', Auth::guard('practitioner')->user()->id)
        ->groupBy('patient_id')
        ->pluck('patient_id')
        ->toArray();
        ...
        return view('practitioner.patient.index', ['patients' => $patients, 'title' => 'Patients']);
    }
    ...
    public function create($fromAppointment = null)
    {
        ...
        return view('practitioner.patient.create', ['title' => 'Create Patient', 'allergies' => $allergies, 'drugs' => $drugs]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if(Session::has('fromAppointment') && Session::get('fromAppointment') == 1)
        {
            ...
            return redirect()->route('practitionerAppointmentCreate')->with('success-message', 'Patient Added Successfully.');
        }

        return redirect()->route('practitionerPatientList')->with('success-message', 'Record Added Successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('practitioner.patient.edit', ['title' => 'Edit Patient', 'patient' => $patient, 'allergies' => $allergies, 'drugs' => $drugs]);
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('practitionerPatientList')->with('success-message', 'Record Updated Successfully.');
    }
    ...
    public function setAppointment($id){
        ...
        return view('practitioner.appointment.createAppointment', ['clinics' => $clinics,  'patient' => $patient,'title' => 'Create Appointment']);
    }
    ...
    public function detail($id)
    {
        ...
        return view('practitioner.patient.detail', ['title' => 'Patient Detail', 'patient' => $patient]);
    }
    ...
    public function patientPreviousVisits($id)
    {
        ...
        return view('practitioner.patient.patientVisitListings', ['patientVisits' => $patientVisits, 'title' => 'Patients Visits']);
    }
    ...
    public function patientPreviousVisitDetail($id)
    {
        ...
        return view('practitioner.patient.patientPreviousVisitDetail', ['patient' => $patient,
