...
{{--        </div>--}}
        <div class="col-lg-12 mt-31">
            ...
            @if(isset($patient->age) && isset($patient->gender))
                <p><b>Age / Sex:</b> {{ $patient->age }} Years @if($patient->gender == 1) Male @elseif($patient->gender == 2) Female @elseif($patient->gender == 3) Other @endif </p>
            @endif
    ...
    <div class="container asseement-plan">
        ...
        @endif
                ...
                <P>Follow up visit after @if(isset($patientVisit->next_visit)) {{ $patientVisit->next_visit }} @endif
{{--                    @if(isset($patientVisit->next_visit_date)) ({{ date('d-M-Y', strtotime($patientVisit->next_visit_date)) }}) @endif--}}
                </p>
                <br>
                @endif
                ...
                <div class="signature">
                    <img style="width:154px;" src="{{ asset('storage/app/public/'.$practitioner->prescription_pad_other_image) }}" alt="Practitioner Signature">
                    @if(isset($practitioner->name))
