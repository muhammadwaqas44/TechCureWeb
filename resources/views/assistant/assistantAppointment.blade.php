        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-6">
                ...
                <div id="logo_home">
                    ...
                    <h1><a href="{{route('indexPage')}}" title="Find Doctor"><img style="height:60px; width:120px;"

                                                                                  src="{{asset('public/images/favicon.ico')}}">

                            <h2 class="mt-4">EON Health - Video Calling</h2>
        ...
        <div class="w-100">
            ...
            <div class="row" style="margin: 0">
                ...
                <div class="col s12">
                    ...
                    <button class="btn btn-raised btn-primary waves-effect waves-light" id="join">START</button>

                    <button class="btn btn-raised btn-primary waves-effect waves-light" id="leave">END</button>
...
id="unpublish">UNPUBLISH</button> --}}
        ...
        <script>
            ...
            $("#join").on('click', function () {
                ...
                rtc.client.join(option.token ? option.token : null, option.channel, option.uid ? +option
