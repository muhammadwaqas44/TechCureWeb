         ...
         <div class="row h-100">
            ...
            <div class="col-sm-6 col-lg-6 d-flex align-items-center justify-content-center">
               <div class="box-contain">
                  ...
                  <form method="POST" class="main-form" action="{{ route('assistantLogin') }}">
                    @csrf
                    ...
                    @endif
                     ...
                     <div class="clearfix SourceSansProRegular">
                        ...
                        <a href="{{ route('assistantPasswordForgotForm') }}" class="float-right blue-color">Forgot Password</a>
                        <div class="login-btn">
                           <button type="submit" value="login"> Login</button>
                           <a href="{{ route('assistantRegisterForm') }}" class="singup">Sign Up</a>
                        </div>
                     </div>
                  </form>
               </div>
