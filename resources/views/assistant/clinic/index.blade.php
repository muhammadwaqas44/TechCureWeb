                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row pt-10">
                                <div class="col-lg-12">
                                    <h2>Practitioner Clinics</h2>
                                </div>
                            </div>
                        </div>

                        <div class="card-body">
                            <table id="practitionerClinic" class="display">
                                <thead>
                                    <tr>
                                        <th>Sr#</th>
                                        <th>Name</th>
                                ...
                                <tbody>
                                    @foreach ($clinics as $item)
                                        <tr>
                                            ...
                                            <td>{{$item->phone}} </td>
                                            <td>
                                                <a class="btn btn-success" href="{{route('clinicProfile',$item->id)}}"><i class="fa fa-eye" ></i> View</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
