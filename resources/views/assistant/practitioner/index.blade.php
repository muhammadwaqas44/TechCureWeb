                                ...
                                <tbody>
                                    @foreach ($practitioners as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary" href="{{route('assistantPractitionerDetail',$item->id)}}"><i class="fa fa-eye" ></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
...
@section('scripts')
    <script src="{{asset('public/assistant/js/practitioner.js')}}"></script>
@endsection
