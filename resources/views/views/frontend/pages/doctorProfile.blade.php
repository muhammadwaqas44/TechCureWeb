						...
						<div class="box_general_3">
							<div class="profile">
								<div class="row">
									<div class="col-lg-5 col-md-4">
										<figure>
											<img @if($doctor->image) src="{{asset('storage/app/public/'.$doctor->image)}}" style="width:260px;height:260px" @else src="{{asset('public/frontend/img/doctor_listing_3.jpg')}}" @endif class="img-fluid" alt="">
										</figure>
									</div>
							...
							<div class="wrapper_indent">
								...
								<ul class="bullets">
                                    ...
                                    ( {{ date("h:i a", strtotime($item->from_time)) }} to {{ date("h:i a", strtotime($item->to_time)) }} )</li>
				...
				<aside class="col-xl-4 col-lg-4" id="sidebar">
					<div class="box_general_3 booking">
						<form>
							...
							<a href="{{route('homeScreen')}}" class="btn_1 full-width">Book Now</a>
						</form>
					</div>
					<!-- /box_general -->
				</aside>
