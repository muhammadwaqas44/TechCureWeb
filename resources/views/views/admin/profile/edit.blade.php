                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form role="form" method="post" action="{{ route('adminUpdateProfile') }}">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="" name="user_name" placeholder="Enter name" value="{{ Auth::user()->name }}" required>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="" name="user_email" placeholder="Enter email" value="{{ Auth::user()->email }}"  readonly>
