  ...
  <body class="hold-transition login-page">
    ...
    <div class="login-box" >
      <div class="login-logo">
        <a href="{{route('homeScreen')}}"><b>EON Health</b>-Panel</a>
      </div>
      <div class="card">
        <div class="card-body login-card-body">
          <p class="login-box-msg">Sign in to start your session</p>

          <form method="POST" action="{{ route('clinicLogin') }}">
            @csrf
            ...
            <div class="row">
              <div class="col-12" style="text-align:center">
                ...
                <br>
                <a href="{{route('clinicPasswordForgotForm')}}" class="text-center">Forgot Password?</a>
              </div>
            </div>
