                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Create Clinic Configuration</h3>
                        </div>

                        <div class="card-body">
                            <form role="form" class="row" action="{{ route('clinicConfigurationStore') }}"
                                  method="post"
                                            ...
                                            <select name="clinic_id" id="clinic_id"
                                                ...
                                                @foreach($clinics as $clinic)
                                                    <option value="{{ $clinic->id }}"
                                                            @foreach(old('clinic_id', ['value']) as $id)
                                                            @if($clinic->id == $id) selected @endif
                                                        @endforeach
                                                    >{{ $clinic->name }}</option>
                                                @endforeach
                                            </select>
