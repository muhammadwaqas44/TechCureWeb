            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="inner">
                            <h3>{{ $assistantsCount }}<sup style="font-size: 20px"></sup></h3>
                            <p>Total Assistants</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-stats-bars"></i>
                        </div>
                        <a href="{{ route('assistantList') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="inner">
                            <h3>{{ $patientsCount }}<sup style="font-size: 20px"></sup></h3>
                            <p>Total Patients</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-stats-bars"></i>
                        </div>
                        <a href="{{ route('patientList') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
