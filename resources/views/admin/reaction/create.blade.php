                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Create Reaction</h3>
                        </div>

                        <div class="card-body">
                            <form role="form" class="row" action="{{ route('reactionStore') }}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 multiselect-options">
                                            ...
                                            <select name="drug_id" id="drug_id" class="form-control {{ $errors->has('drug_id') ? ' is-invalid' : '' }}" required>
                                                ...
                                                @foreach ($drugs as $drug)
                                                    <option @if(old('drug_id') == $drug->id) selected @endif value="{{ $drug->id }}">{{ $drug->title }}</option>
                                                @endforeach
                                            </select>
