            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form role="form" class="row" action="{{ route('practitionerUpdate') }}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email" id="email" disabled
                                                ...
                                                placeholder="Enter Email" value="{{ $practitioner->email }}" required>
                                                            ...
                                                            <div class="bootstrap-timepicker">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group date from_time"  id="from_time_0" data-target-input="nearest">
                                                                        <input type="text" name="from_time" class="form-control datetimepicker-input" data-target="#from_time_0" value="{{ $old_clinics[0][$i]['from_time'] }}" required/>
                                                            ...
                                                            <div class="bootstrap-timepicker">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group date to_time" id="to_time_0" data-target-input="nearest">
                                                                        <input type="text" name="to_time" class="form-control datetimepicker-input" data-target="#to_time_0" value="{{ $old_clinics[0][$i]['to_time'] }}" required/>
                                            ...
                                            padding-right: 10px;">
                                                ...
                                                <div data-repeater-item class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-2 col-lg-2">
                                                        <div class="bootstrap-timepicker">
                                                            <div class="form-group">
                                                                <label>Opening Time <span style="color:red">*</span></label>
                                                                <div class="input-group date from_time"  id="from_time_0" data-target-input="nearest">
                                                                    <input type="text" name="from_time" class="form-control datetimepicker-input" data-target="#from_time_0" value="{{ $practitioner->from_time }}" required/>
                                                                    <div class="input-group-append" data-target="#from_time_0" data-toggle="datetimepicker">
                                                                        <div class="input-group-text"><i class="far fa-clock"></i></div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-2 col-lg-2">
                                                        <div class="bootstrap-timepicker">
                                                            <div class="form-group">
                                                                <label>Closing Time <span style="color:red">*</span></label>
                                                                <div class="input-group date to_time" id="to_time_0" data-target-input="nearest">
                                                                    <input type="text" name="to_time" class="form-control datetimepicker-input" data-target="#to_time_0" value="{{ $practitioner->to_time }}" required/>
                                                                    <div class="input-group-append" data-target="#to_time_0" data-toggle="datetimepicker">
                                                                        <div class="input-group-text"><i class="far fa-clock"></i></div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-2 col-lg-2">
                                                        <div class="form-group">
                                                            <label>Fee (PKR) (Physical) <span style="color:red">*</span></label>
                                                            <input type="number" min="0" name="physical_fee" class="form-control " value="{{ $practitioner->physical_fee }}" required/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-2 col-lg-2">
                                                        <div class="form-group">
                                                            <label>Fee (PKR) (Online) <span style="color:red">*</span></label>
                                                            <input type="number" min="0" name="online_fee" class="form-control " value="{{ $practitioner->online_fee }}" required/>
                                                        </div>
                                                    </div>
                                                </div>
