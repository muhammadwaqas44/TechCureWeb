            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form role="form" class="row" action="{{ route('prescriptionUpdate') }}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="row" style="width:100%">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="practitioner_id" id="practitioner_id" required class="form-control {{ $errors->has('practitioner_id') ? ' is-invalid' : '' }}" title="Select Practitioner" >
                                                <option value="" selected disabled>Select Practitioner</option>
                                                @foreach($practitioners as $practitioner)
                                                    <option value="{{ $practitioner->id }}" @if($prescription->practitioner->id == $practitioner->id) selected @endif>{{ $practitioner->name }}</option>
                                                @endforeach
                                            </select>
