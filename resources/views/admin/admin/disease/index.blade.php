                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row pt-10">
                                <div class="col-lg-12">
                                    <a href="{{ route('diseaseCreate') }}" class="btn btn-primary pull-right">Add Disease</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($diseases as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success" href="{{route('diseaseEdit',$item->id)}}"><i class="fa fa-edit" ></i></a>
