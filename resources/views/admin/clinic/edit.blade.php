                                            ...
                                            <select name="lab_tests[]" id="lab_tests" multiple="multiple"
                                                ...
                                                @foreach($labTests as $labTest)
                                                    <option value="{{ $labTest->id }}"
                                                            @foreach($clinic->labTests as $clinicLabTest)
                                                            @if($labTest->id == $clinicLabTest->id) selected @endif
                                                        @endforeach
                                            ...
                                            <select name="medications[]" id="medications" multiple="multiple"
                                                ...
                                                @foreach($medications as $medication)
                                                    <option value="{{ $medication->id }}"
                                                            @foreach($clinic->medications as $clinicMedication)
                                                            @if($medication->id == $clinicMedication->id) selected @endif
                                                        @endforeach
                                ...
                                <div class="row" style="width:100%">
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="cleafix"></div>
                                            <select name="departments[]" id="departments" multiple data-live-search="true"
                                                class="selectpicker form-control" >
                                                @foreach($departments as $department)
                                                    <option value="{{$department->id}}"
                                                        @foreach($clinic->departments as $clinicDepartment)
                                                            @if($department->id == $clinicDepartment->id) selected @endif
                                                        @endforeach
                                                        >
                                                        {{ $department->title }}
                                                    </option>
