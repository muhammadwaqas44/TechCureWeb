                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row pt-10">
                                <div class="col-lg-12">
                                    <a href="{{ route('durationCreate') }}" class="btn btn-primary pull-right">Add Duration</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($durations as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success" href="{{route('durationEdit',$item->id)}}"><i class="fa fa-edit" ></i></a>
