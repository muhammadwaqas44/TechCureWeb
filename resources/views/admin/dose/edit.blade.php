                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Dose</h3>
                        </div>

                        <div class="card-body">
                            <form role="form" class="row" action="{{ route('doseUpdate') }}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="dose" id="dose"
                                                    ...
                                                    placeholder="Enter Dose" value="{{ $dose->dose }}" required>
                                                @if ($errors->has('dose'))
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6">
                                            <div class="form-group ">
                                                ...
                                                <select name="status" id="status"
                                                    ...
                                                    <option {{ ($dose->status == 1)? 'Selected':'' }} value="1">Active
                                                    </option>
                                                    <option {{ ($dose->status == 0)? 'Selected':'' }} value="0">In-Active
                                                    </option>
                                                </select>
