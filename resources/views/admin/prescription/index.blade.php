                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row pt-10">
                                <div class="col-lg-12">
                                    <a href="{{ route('prescriptionCreate', $patient->id) }}" class="btn btn-primary pull-right">Add Prescription</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($prescriptions as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success" href="{{route('prescriptionEdit',$item->id)}}"><i class="fa fa-edit" ></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
