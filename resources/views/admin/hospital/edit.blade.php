            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form role="form" class="row" action="{{ route('hospitalUpdate') }}" method="post"
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" id="title"
                                                   ...
                                                   placeholder="Enter Name" value="{{$hospital->title}}" required>
                                            @if ($errors->has('title'))
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" id="email"
                                                   ...
                                                   placeholder="Enter Email" value="{{ $hospital->email}}" required>
                                            @if ($errors->has('email'))
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter Phone "
                                                   ...
                                                   name="contact_no"
                                                   class="form-control {{ $errors->has('contact_no') ? ' is-invalid' : '' }}"
                                                   value="{{ $hospital->contact_no }}" required>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group ">
                                            ...
                                            <select name="status" id="status"
                                                ...
                                                <option value="1" {{ ($hospital->status == '1') ? 'selected' : '' }}>
                                                    Active
                                                </option>
                                                <option value="0" {{ ($hospital->status == '0') ? 'selected' : '' }}>
                                                    In-Active
                                                </option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="departments[]" id="departments" multiple="multiple"
                                                ...
                                                @foreach($departments as $department)
                                                    <option
                                                        value="{{ $department->id }}"
                                                        {{--                                                        {{ ($hospital->department_id == $department->id) ? 'selected' : '' }}--}}
                                                        @foreach($hospital->departments as $item)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="facilities[]" id="facilities" multiple="multiple"
                                                ...
                                                @foreach($facilities as $facility)
                                                    <option
                                                        value="{{ $facility->id }}"
                                                        {{--                                                        {{ ($hospital->facilities == $facility->id) ? 'selected' : '' }}--}}
                                                        @foreach($hospital->facilities as $item)
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="all_time" id="all_time"
                                                ...
                                                <option {{ ($hospital->all_time == 1) ? ' selected' : '' }} value="1">
                                                    24/7
                                                </option>
                                                <option {{ ($hospital->all_time == 0) ? ' selected' : '' }} value="0">
                                                    Timing (Form-To)
                                                </option>
                                            </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group date from_time" id="from_time"
                                                                ...
                                                                <input type="text" name="from_time"
                                                                       ...
                                                                       value="{{($hospital->all_time == 0) ? \Carbon\Carbon::parse($hospital->from_time)->isoFormat('h:mm A') : ''}}"
                                                                />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group date to_time" id="to_time"
                                                                ...
                                                                <input type="text" name="to_time"
                                                                       class="form-control datetimepicker-input"
                                                                       data-target="#to_time"
                                                                       value="{{ ($hospital->all_time == 0) ? \Carbon\Carbon::parse($hospital->to_time)->isoFormat('h:mm A'):'' }}"
                                                                />
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group ">
                                            ...
                                            <textarea rows="2" name="address"
                                                      style="width:100% !important">{{ $hospital->address}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group ">
                                            ...
                                            <textarea rows="5" name="description"
                                                      style="width:100% !important">{{ $hospital->about}}</textarea>
                                        </div>
                                    </div>
                                </div>
