                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Create Lab Test</h3>
                        </div>

                        <div class="card-body">
                            <form role="form" class="row" action="{{ route('labTestStore') }}" method="post"
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group ">
                                            ...
                                            <select name="fasting" id="fasting"
                                                    ...
                                                    required>
                                                <option selected
                                                        value="1" {{ (old('fasting') == '1') ? 'selected' : '' }}>
                                                    True
                                                </option>
                                                <option value="0" {{ (old('fasting') == '0') ? 'selected' : '' }}>
                                                    False
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12 multiselect-options">
                                        <div class="form-group ">
                                            ...
                                            <select name="lab_id" id="lab_id"
                                                ...
                                                <option value="" selected disabled>Select Lab</option>
                                                @foreach($labs as $lab)
                                                    <option value="{{$lab->id}}" {{ (old('lab_id') == $lab->id) ? 'selected' : '' }}>{{$lab->title}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group ">
                                            ...
                                            <textarea rows="5" name="instructions"
                                                      style="width:100% !important">{{ old('instructions') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group ">
