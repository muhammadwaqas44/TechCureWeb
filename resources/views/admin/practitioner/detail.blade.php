                    ...
                    <div class="card">
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                @endif
                                @if(isset($practitioner->agora_app_id))
                                    <tr>
                                        <td><b>Agora App Id</b></td>
                                        <td>{{ $practitioner->agora_app_id }}</td>
                                    </tr>
                                @endif
                                @if(isset($practitioner->agora_app_token))
                                    <tr>
                                        <td><b>Agora App Token</b></td>
                                        <td>{{ $practitioner->agora_app_token }}</td>
                                    </tr>
                                @endif

                                @if($practitioner->license_image != null && Storage::exists($practitioner->license_image))
                                    <tr>
                                ...
                                <tr>
                                    <td><b>Patients</b></td>
                                    <td>
                                        <a href="{{ route('practitionerPatients', $practitioner->id) }}">{{ $practitioner->practitionerPatients() }}
                                            Patient(s)</a></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('practitionerAppointments', $practitioner->id) }}"> {{ $practitioner->practitionerAppointments() }}
                                            Appointment(s) </a></td>
                                </tr>

                                <tr>
                                    <td><b>Assistants</b></td>
                                    <td>
                                        <a href="{{ route('practitionerAssistants', $practitioner->id) }}"> {{ $practitioner->practitionerAssistants() }}
                                            Assistant(s) </a></td>
                                </tr>
                                </tbody>
                            </table>
                                ...
                                <table class="table table-striped">
                                    ...
                                    @if(isset($clinic->from_time) && isset($clinic->to_time))
                                        <tr>
                                            ...
                                            <td>
                                                {{ date("h:i A", strtotime($clinic->from_time)) }}
                                                - {{ date("h:i A", strtotime($clinic->to_time)) }}
                                            </td>
                                        </tr>
                                    @endif
