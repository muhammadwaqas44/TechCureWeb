                                    ...
                                    @foreach ($practitioners as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endif
                                                <a class="btn btn-success" href="{{ route('practitionerPatients', $item->id) }}">Patients ({{ $item->practitionerPatients() }})</a>
                                                <a class="btn btn-success" href="{{ route('practitionerAppointments', $item->id) }}">Appointments ({{ $item->practitionerAppointments() }})</a>
                                                <a class="btn btn-success mt-1" href="{{ route('practitionerAssistants', $item->id) }}">Assistants ({{ $item->practitionerAssistants() }})</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
