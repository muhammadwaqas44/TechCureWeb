                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Create Medication</h3>
                        </div>

                        <div class="card-body">
                            <form role="form" class="row" action="{{ route('medicationStore') }}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="generic_name" id="generic_name"
                                                    ...
                                                    placeholder="Enter Generic Name" value="{{ old('generic_name') }}">
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 multiselect-options">
                                            ...
                                            <select name="dose_id" id="dose_id" class="form-control {{ $errors->has('dose_id') ? ' is-invalid' : '' }}" required>
                                                ...
                                                @foreach ($doses as $dose)
                                                    <option @if(old('dose_id') == $dose->id) selected @endif value="{{ $dose->id }}">{{ $dose->dose }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 multiselect-options">
                                            ...
                                            <select name="unit_id" id="unit_id" class="form-control {{ $errors->has('unit_id') ? ' is-invalid' : '' }}" required>
                                                ...
                                                @foreach ($units as $unit)
                                                    <option @if(old('unit_id') == $unit->id) selected @endif value="{{ $unit->id }}">{{ $unit->unit }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 multiselect-options mt-3">
                                            ...
                                            <select name="frequency_id" id="frequency_id" class="form-control {{ $errors->has('frequency_id') ? ' is-invalid' : '' }}" required>
                                                ...
                                                @foreach ($frequencies as $frequency)
                                                    <option @if(old('frequency_id') == $frequency->id) selected @endif value="{{ $frequency->id }}">{{ $frequency->frequency }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 mt-3 multiselect-options">
                                            ...
                                            <select name="duration_id" id="duration_id" class="form-control {{ $errors->has('duration_id') ? ' is-invalid' : '' }}" required>
                                                ...
                                                @foreach ($durations as $duration)
                                                    <option @if(old('duration_id') == $duration->id) selected @endif value="{{ $duration->id }}">{{ $duration->duration }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 mt-3 multiselect-options">
                                            ...
                                            <select name="diagnosis_type_id" id="diagnosis_type_id" class="form-control {{ $errors->has('diagnosis_type_id') ? ' is-invalid' : '' }}" required>
                                                ...
                                                @foreach ($diagnosisTypes as $diagnosisType)
                                                    <option @if(old('diagnosis_type_id') == $diagnosisType->id) selected @endif value="{{ $diagnosisType->id }}">{{ $diagnosisType->type }}</option>
                                                @endforeach
                                            </select>
