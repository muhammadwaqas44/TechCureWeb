                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <table class="table table-striped">
                                            <h5 class="ml-2 mt-2 mb-2"> Patient Details</h5>
                                            <tbody>
                                                <tr> 
                                                        ...
                                                        @foreach($patientReports as $report)
                                                            <div class="item col-xs-2 col-lg-2 target del">
                                                                <div class="thumbnail card mt-2 mb-2">
                                                                    ...
                                                                    <div class="mb-2" style="text-align:center">{{ $report->title }} @if($report->type == 0) (Lab Test) @elseif($report->type == 1) (Invoice) @elseif($report->type == 2) (Other) @endif</div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="{{asset('storage/app/public/'.$report->image_url)}}" class="img-responsive img-center-popup" style="max-width:750px; max-height:800px;">
                </div>
            </div>
        </div>
    </div>
