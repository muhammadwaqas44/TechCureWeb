            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form role="form" class="row" action="{{ route('patientUpdate') }}" method="post" enctype="multipart/form-data" autocomplete="on">
                                {{csrf_field()}}
                                ...
                                <div class="row" style="width:100%">
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email" id="email" disabled autocomplete="off"
                                ...
                                <div class="row" style="width:100%">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select name="status" id="status"
                                            ...
                                            <option {{ ($patient->status == 1)? 'Selected':'' }} value="1">Active
                                            </option>
                                            <option {{ ($patient->status == 0)? 'Selected':'' }} value="0">In-Active
                                            </option>
                                        </select>
                                ...
                                <div class="row" style="width:100%">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6" id="weight_kgs_div">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6" id="weight_lbs_div">
                                    ...
                                    <div class="col-sm-6 col-md-3 col-lg-3" id="height_ft_div">
                                    ...
                                    <div class="col-sm-6 col-md-3 col-lg-3" id="height_in_div">
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6" id="height_cms_div">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 drug-dropdown mt-2" id="drugs_div">
                                        <div class="form-group">
                                            ...
                                            <select name="drugs[]" id="drugs" multiple data-live-search="true"
                                                class="selectpicker form-control" title="Select Drugs">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="patient_type_id" required id="patient_type_id" class="form-control {{ $errors->has('patient_type_id') ? ' is-invalid' : '' }}">
                                                ...
                                                @foreach($patientTypes as $patientType)
                                                    <option value="{{ $patientType->id }}" {{ ($patient->patient_type_id == $patientType->id) ? 'selected' : '' }}>{{ $patientType->title }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    @foreach ($patient->reports as $item)
                                        <div class="item col-xs-2 col-lg-2 target del" data-id={{ $item->id }}>
                                            <div class="thumbnail card">
                                                ...
                                                <div style="text-align:center">
                                                    <button type="button" onclick="deleteFunction('{{ $item->id }}')" class="btn btn-danger"><i class="fa fa-trash"></i></button>
