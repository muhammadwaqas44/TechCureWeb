            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form role="form" class="row" action="{{ route('patientStore') }}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                    ...
                                    <div class="row" style="width:100%">
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 drug-dropdown mt-3 {{ (old('currently_on_drug') == '1') ? '' : 'hidden' }}" id="drugs_div">
                                            <div class="form-group">
                                        ...
                                        {{-- <div class="col-sm-12 col-md-6 col-lg-6 mt-3">
                                            <div class="form-group">
                                                ...
                                                <select name="patient_type_id" id="patient_type_id"
                                                    class="form-control {{ $errors->has('patient_type_id') ? ' is-invalid' : '' }}" required>
                                                    <option value="" selected disabled>Select Patient Type</option>
                                                    @foreach($patientTypes as $patientType)
                                                        <option value="{{ $patientType->id }}" {{ (old('patient_type_id') == $patientType->id) ? 'selected' : '' }} >{{ $patientType->title }}</option>
                                                    @endforeach
                                                </select>
