                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Create Frequency</h3>
                        </div>

                        <div class="card-body">
                            <form role="form" class="row" action="{{ route('frequencyStore') }}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="frequency" id="frequency"
                                                    ...
                                                    placeholder="Enter Frequency" value="{{ old('frequency') }}" required>
