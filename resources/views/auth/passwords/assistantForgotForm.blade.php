...
<head>
    ...
    <title>EON Health-Practitioner Forgot Password</title>
...
<div class="logo-div"><a href="{{route('indexPage')}}"><img style="width:140px" src="{{ asset('storage/app/public/logo.png') }}"></a></div>
<div class="login-box" >
    <div class="login-logo">
        <a href="#"><b>EON Health</b>-Assistant Panel</a>
    </div>
    <div class="card">
        <div class="card-body ">
        ...
        <div class="row" style="margin-bottom:20px">
            <div class="col-12" style="text-align:center">
                ...
                <br>or
                <br>
                <a href="{{route('practitionerLoginForm')}}">Login</a>
            </div>
        </div>
...
<script>
    var routes = {
        assistantPasswordForgotEmail : "{{route('assistantPasswordForgotEmail')}}",
    };
</script>

<script src="{{asset('public/assistant/js/passwordReset.js')}}"></script>
