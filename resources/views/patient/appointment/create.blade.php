                            ...
                            <form role="form" class="row" action="{{ route('patientAppointmentStore') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row" style="width:100%">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            <label>Payable </label>
                                            <input type="number" name="fee" id="fee" readonly
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group ">
                                            ...
                                            <select name="payment_method" id="payment_method"
                                                ...
                                                <option value="Online" {{ (old('payment_method') == 'Online') ? 'selected' : '' }}>Online (EasyPiasa, | Credit Card | Mobile Account | QR Code)</option>
                                            </select>
