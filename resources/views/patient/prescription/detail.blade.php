                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row pt-10">
                                <div class="col-lg-6">
                                    <a href="{{ route('patientPreviousVisitsList') }}"
                                       class="btn btn-primary pull-right">Back</a>
                                </div>
                                @if(isset($patientVisit->pdf_report) && $patientVisit->pdf_report != null)
                                    <div class="col-lg-6" style="float: right;text-align: right;">
                                        <a href="{{  URL::to('/') . '/reports/' . $patientVisit->pdf_report }}"
                                           class="btn btn-primary pull-right" target="_blank">Download Prescription</a>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <div class="row">
                                ...
                                @if(isset($patient))
                                    <div class="col-12">
                                        <table class="table table-striped">
                                            <h5 class="ml-2 mt-2 mb-2"> Your Details</h5>
                                            <tbody>
                                            <tr>
                                            ...
                                            @if(isset($patient->gender))
                                                <tr>
                                                    <td><b>Gender</b></td>
                                                    <td>@if($patient->gender==1) Male @elseif($patient->gender==2)
                                                            Female @else Other @endif</td>
                                                </tr>
                                            @endif
                                ...
                                @if(isset($practitioner))
                                    <div class="col-12">
                                        <table class="table table-striped">
                                            <h5 class="ml-2 mt-2 mb-2"> Practitioner Details</h5>
                                            <tbody>
                                            <tr>
                                            ...
                                            @if($practitioner->image != null && Storage::exists($practitioner->image))
                                                <tr>
                                                    ...
                                                    <td><img
                                                            src="{{ asset('storage/app/public/'.$practitioner->image) }}"
                                ...
                                @if(isset($patientAppointment))
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="table-responsive">
                                                <table class="table table-striped">
                                                    <h5 class="ml-2 mt-2 mb-2"> Appointment Details</h5>
                                                    <tbody>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($patientAppointment->status == 0)
                                                                Pending
                                                            @elseif($patientAppointment->status == 1)           Under
                                                            Process
                                                            ...
                                                            @elseif($patientAppointment->status == 5)
                                                                Completed
                                                            @endif
                                                        </td>
                                                    </tr>
                                ...
                                @if(isset($patientVisit))
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="table-responsive">
                                                <table class="table table-striped">
                                                    <h5 class="ml-2 mt-2 mb-2"> Visit Details</h5>
                                                    <tbody>
                                ...
                                @if(isset($patientVitals))
                                    @if(isset($patientVitals->bp_sys) || isset($patientVitals->bp_dias) || isset($patientVitals->pulse) || isset($patientVitals->weight_lbs) || isset($patientVitals->weight_kgs) || isset($patientVitals->height_ft) || isset($patientVitals->height_in) || isset($patientVitals->height_cms) || isset($patientVitals->bmi) || isset($patientVitals->bsf) || isset($patientVitals->bsr))
                                        <div class="col-6">
                                            <table class="table table-striped">
                                                <h5 class="ml-2 mt-2 mb-2"> Vitals 1</h5>
                                                <tbody>
                                    ...
                                    @if(isset($patientVitals->bp_sys_2) || isset($patientVitals->bp_dias_2) || isset($patientVitals->pulse_2) || isset($patientVitals->weight_lbs_2) || isset($patientVitals->weight_kgs_2) || isset($patientVitals->height_ft_2) || isset($patientVitals->height_in_2) || isset($patientVitals->height_cms_2) || isset($patientVitals->bmi_2) || isset($patientVitals->bsf_2) || isset($patientVitals->bsr_2))
                                        <div class="col-6">
                                            <table class="table table-striped">
                                                <h5 class="ml-2 mt-2 mb-2"> Vitals 2</h5>
                                                <tbody>
                        ...
                        <div class="card">
                            <div class="table-responsive">
                                ...
                                @foreach($patientPrescriptions as $patientPrescription)
                                    <table class="table table-striped">
                                        <h5 class="ml-2 mt-4 mb-2"> Prescription {{ $count }}</h5>
                                        <tbody>
                ...
                @if(count($patientReports) > 0)
                    <div class="col-12">
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <h5 class="ml-2 mt-2 mb-2"> Attachments </h5>
                                    <tbody>
                                    <tr>
                                        <td>
                                                ...
                                                @foreach($patientReports as $report)
                                                    <div class="item col-xs-2 col-lg-2 target del">
                                                        <div class="thumbnail card mt-2 mb-2">
                                                            <a class="img-event mt-3 mb-2" style="text-align:center"
                                                               type="button" data-toggle="modal"
                                                               data-target="#reportsPopupDetailPage{{$report->id}}">
                                                                <i class="fa fa-image fa-5x group list-group-image img-fluid"></i>
                                                            </a>
                                                            <div class="mb-2"
                                                                 style="text-align:center">{{ $report->title }} @if($report->type == 0)
                                                                    (Lab Test) @elseif($report->type == 1)
                                                                    (Invoice) @elseif($report->type == 2)
                                                                    (Other) @endif</div>

                                                            <div class="mb-2"
                                                                 style="text-align:center"> {{\Carbon\Carbon::parse($report->created_at)->format('d M, Y')}} </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
                ...
                @if(isset($patientReferTo->referral_practitioner_name))
                    <div class="col-12">
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <h5 class="ml-2 mt-2 mb-2">Refer To Practitioner</h5>
                                    <tbody>
                                    <tr>
                    ...
                    <div class="table-responsive" style="background-color:white;">
                        <div class="row ml-2 mr-2">
                            ...
                            @foreach($patientPhysicalExaminations as $patientPhysicalExamination)
                                <div class="col-6">
                                    <table class="table table-striped">
                                        <h5 class="ml-2 mt-3 mb-2"> Physical Examination {{ $count }} </h5>
                                        <tbody>
                ...
                @if(isset($history->description))
                    <div class="table-responsive" style="background-color:white;">
                        <div class="row ml-2 mr-2">
                            <div class="col-12">
                                <table class="table table-striped">
                                    <h5 class="ml-2 mt-3 mb-2"> Patient History </h5>
                                    <tbody>
                                    <tr>
                                        <td><b> History </b></td>
                    ...
                    <div class="table-responsive" style="background-color:white;">
                        <div class="row ml-2 mr-2">
                            ...
                            @foreach($patientPastMedicalHistories as $patientPastMedicalHistory)
                                <div class="col-6">
                                    <table class="table table-striped">
                                        <h5 class="ml-2 mt-3 mb-2"> Past Medical History {{ $count }} </h5>
                                        <tbody>
                    ...
                    <div class="table-responsive" style="background-color:white;">
                        <div class="row  ml-2 mr-2">
                            ...
                            @foreach($patientPastSurgicalHistories as $patientPastSurgicalHistory)
                                <div class="col-6">
                                    <table class="table table-striped">
                                        <h5 class="ml-2 mt-3 mb-2"> Past Surgical History {{ $count }} </h5>
                                        <tbody>
                    ...
                    <div class="table-responsive" style="background-color:white;">
                        <div class="row  ml-2 mr-2">
                            ...
                            @foreach($patientFamilyMedicalHistories as $patientFamilyMedicalHistory)
                                <div class="col-6">
                                    <table class="table table-striped">
                                        <h5 class="ml-2 mt-3 mb-2"> Family Medical History {{ $count }} </h5>
                                        <tbody>
                ...
                @if(isset($smokingHistory))
                    <div class="table-responsive" style="background-color:white;">
                        <div class="row ml-2 mr-2">
                            <div class="col-6">
                                <table class="table table-striped">
                                    <h5 class="ml-2 mt-3 mb-2"> Smoking History </h5>
                                    <tbody>
                ...
                @if(isset($ros->first_description) || isset($ros->second_description) || isset($ros->third_description))
                    <div class="table-responsive" style="background-color:white;">
                        <div class="row ml-2 mr-2">
                            <div class="col-12">
                                <table class="table table-striped">
                                    <h5 class="ml-2 mt-3 mb-2"> Review on System </h5>
                                    <tbody>
                    ...
                    <div class="table-responsive" style="background-color:white;">
                        <div class="row  ml-2 mr-2">
                            ...
                            @foreach($adrs as $adr)
                                <div class="col-6">
                                    <table class="table table-striped">
                                        <h5 class="ml-2 mt-3 mb-2"> ADR {{ $count }} </h5>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @foreach($adr->reactions as $reaction)
                                                        <li style="list-style: circle;"> {{ $reaction->reaction->title }} </li>
                                                    @endforeach
                                                </td>
                                            </tr>
                                        @endif
                    ...
                    <div class="table-responsive" style="background-color:white;">
                        <div class="row  ml-2 mr-2">
                            ...
                            @foreach($rxMedicines as $rxMedicine)
                                <div class="col-6">
                                    <table class="table table-striped">
                                        <h5 class="ml-2 mt-3 mb-2"> CuRx (Medicines) {{ $count }} </h5>
                                        <tbody>
                    ...
                    <div class="table-responsive" style="background-color:white;">
                        <div class="row  ml-2 mr-2">
                            ...
                            @foreach($patientLabTests as $patientLabTest)
                                <div class="col-6">
                                    <table class="table table-striped">
                                        <h5 class="ml-2 mt-3 mb-2"> Lab Tests {{ $count }} </h5>
                                        <tbody>
                                        ...
                                        @if(isset($patientLabTest->recommended_lab))
                                            <tr>
                                                ...
                                                <td>{{ $patientLabTest->recommendedLabTest->title }}</td>
                                            </tr>
                                        @endif
                ...
                @if(isset($patientSugarChart))
                    <div class="col-12">
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <h5 class="ml-2 mt-2"> Sugar Chart </h5>
                                    <tbody>
                    ...
                    <div class="modal-content">
                        <div class="modal-header" id="modal-header">
                            <h5 class="modal-title" id="modal-title">
                                ...
                                ) @if($report->type == 0) (Lab Test) @elseif($report->type == 1)
                                    (Invoice) @elseif($report->type == 2) (Other) @endif
                            </h5>
                        ...
                        <div class="modal-body">
                            <img src="{{asset('storage/app/public/'.$report->image_url)}}"
                                 class="img-responsive img-center-popup" style="max-width:750px; max-height:800px;">
                        </div>
                    </div>
                </div>
            </div>
