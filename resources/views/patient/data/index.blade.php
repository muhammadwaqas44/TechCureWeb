            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form role="form" class="row" action="{{ route('patientUpdateData') }}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="row" style="width:100%">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 drug-dropdown" id="drugs_div">
                                        <div class="form-group">
                                    ...
                                    @foreach ($patient->reports as $item)
                                        <div class="item col-xs-2 col-lg-2 target del" data-id={{ $item->id }}>
                                            <div class="thumbnail card">
                                                ...
                                                <div  style="text-align:center">
                                                    <button type="button" onclick="patientReportDeleteFunction('{{ $item->id }}')" class="btn btn-danger"><i class="fa fa-trash"></i></button>
