...
@include('frontend.layout.header')
                ...
                <nav class="col-lg-9 col-6">
                    ...
                    <div  class="main-menu main_nav">
                        <ul>
                            ...
                            <li><a href="{{route('practitionerLoginForm')}}">Practitioner Login</a></li> --}}
                            <li class="submenu">
                            ...
                            <li><a href="{{route('practitionerLoginForm')}}">Practitioner Login</a></li>
                            <li><a href="{{route('practitionerLoginForm')}}">Patient Login</a></li>
                            <li class="submenu">
    ...
    <main id="top1">
         ...
         <div class="header-video text-left" style="color: grey">
            <div id="hero_video">
            ...
            <img src="{{asset('public/frontend/img/banner4.jpg')}}" alt="" class="header-video--media" data-video-src="{{asset('public/frontend/video/intro')}}" data-teaser-source="{{asset('public/frontend/video/intro')}}" data-provider="" data-video-width="1920" data-video-height="750">
        </div>
...
{{--        </div>--}}
        ...
        <!-- <h1 class="text-center" style="margin-top:15%; margin-bottom:15%"> EON Health System </h1> -->
