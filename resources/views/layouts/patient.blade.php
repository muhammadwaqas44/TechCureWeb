    ...
    <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed ">
                ...
                <div class="sidebar">
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="{{route('patientPreviousVisitsList')}}" class="nav-link
                                {{ (Route::currentRouteName() == 'patientPreviousVisitsList' || Route::currentRouteName() == 'patientPreviousVisitDetailInPatient') ? 'active' : '' }}
                                ">
        ...
        <script>
            var routes = {
                ...
                getPractitionerPatientFee : "{{route('getPractitionerPatientFee')}}",
