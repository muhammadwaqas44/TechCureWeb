...
<div class="col-lg-12 col-md-12 col-sm-12" align="right" style="margin-top: 18px !important;">
    <a type="button" class="back-btn-custom" href="{{ url()->previous() }}">Back</a>
</div>
...
<div class="container">
    ...
    <div class="col-lg-12 mt-31">
        ...
        @if(isset($patient->age) && isset($patient->gender))
            <p>{{ $patient->age }} Years @if($patient->gender == 1) Male @elseif($patient->gender == 2)
                    Female @elseif($patient->gender == 3) Other @endif </p>
        @endif
...
<div class="container asseement-plan">
    ...
    @if(isset($patientVisit->next_visit) || isset($patientVisit->next_visit_date))
        ...
        <P>Follow up visit
            after @if(isset($patientVisit->next_visit)) {{ $patientVisit->next_visit }} @endif @if(isset($patientVisit->next_visit_date))
                ({{ date('d-M-Y', strtotime($patientVisit->next_visit_date)) }}) @endif</p>
        <br>
    @endif
...
<footer class="container">
    ...
    @if(isset($practitioner->name))
        ...
        <div class="col-lg-12 text-center" style="text-align:right !important;">
