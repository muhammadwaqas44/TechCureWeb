...
{{--                                </div>--}}
                                ...
                                <div class="col-sm-6" style="text-align: right">
                                  <a class="btn btn-info" href="{{route('dailyReport')}}">Daily Report</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <table id="myTable" class="display">
                                    ...
                                    @foreach ($payments as $item)
                                        <tr>
                                            ...
                                            <td>{{isset($item->patient->name)?$item->patient->name:''}} </td>
                                            ...
                                            <td>
                                                <a class="btn btn-success"
                                                   href="{{route('practitionerPaymentEdit', $item->id)}}"><i
...
@section('scripts')
    <script src="{{asset('public/practitioner/js/payment.js')}}"></script>
