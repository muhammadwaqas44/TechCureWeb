                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row pt-10">
                                ...
                                <div class="col-lg-6">
                                    <a href="{{ route('practitionerPrescriptionTemplateCreate') }}" class="btn btn-primary pull-right">Add Prescription Template</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach($prescriptionTemplates as $prescriptionTemplate)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-success" href="{{route('practitionerPrescriptionTemplateEdit', $prescriptionTemplate->id)}}"><i class="fa fa-edit" ></i></a>
