                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="clearfix">
                        <ul class="m-0 p-0 calender-btns">
                            ...
                            <li>
                                <form>
                                    <a href="{{ route('practitionerAppointmentList') }}"
                            ...
                            <a href="{{ route('practitionerAppointmentCreate') }}" class="btn btn-primary pull-right">Add
                                Appointment</a>
...
{{--                                                    title="Complete" id="complete{{$item['id']}}"></div>--}}
                                            ...
                                            @endif</td>
                                        <td class="d-flex">
                                            <a href="{{route('manageAppointment',['patientId'=>$item['patient']['id'],'appointmentId'=>$item['id'],'practitionerId'=>Auth::guard('practitioner')->user()->id])}}"
                                               class="manage-btn mr-1">Manage</a>
                                            <a href="{{route('practitionerAppointmentEdit',$item['id'])}}"
