...
!function (n) {
    n.version = {versionStr: "2.4.2", major: parseInt("2", 10), minor: parseInt("4", 10), revision: parseInt("2", 10)};
    var t = {
    ...
    n.pixelDensityRatio = function () {
        if (n.supportsCanvas) {
            ...
            var i = e.webkitBackingStorePixelRatio || e.mozBackingStorePixelRatio || e.msBackingStorePixelRatio || e.oBackingStorePixelRatio || e.backingStorePixelRatio || 1;
...
!function ($) {
    $.extend = function () {
        ...
        for (; h < a; h++) if (null !== (e = arguments[h]) || void 0 !== e) for (t in e) {
            i = s[t];
            if (s !== (n = e[t])) if (l && n && (OpenSeadragon.isPlainObject(n) || (o = OpenSeadragon.isArray(n)))) {
                if (o) {
                    o = !1;
    ...
    $.extend($, {
        DEFAULT_SETTINGS: {
        ...
        }, SIGNAL: "----seadragon----", delegate: function (t, i) {
            return function () {
                var e = arguments;
                void 0 === e && (e = []);
                return i.apply(t, e)
            ...
            var t, i, n = new $.Point;
            i = getOffsetParent(e = $.getElement(e), t = "fixed" == $.getElementStyle(e).position);
            for (; i;) {
                n.x += e.offsetLeft;
                n.y += e.offsetTop;
            ...
            var t, i, n = (e = $.getElement(e)) && e.ownerDocument, o = {top: 0, left: 0};
            if (!n) return new $.Point;
            t = n.documentElement;
            void 0 !== e.getBoundingClientRect && (o = e.getBoundingClientRect());
            i = n == n.window ? n : 9 === n.nodeType && (n.defaultView || n.parentWindow);
            return new $.Point(o.left + (i.pageXOffset || t.scrollLeft) - (t.clientLeft || 0), o.top + (i.pageYOffset || t.scrollTop) - (t.clientTop || 0))
        }, getElementSize: function (e) {
            e = $.getElement(e);
            return new $.Point(e.clientWidth, e.clientHeight)
            ...
            return $.getCssPropertyWithVendorPrefix(e)
            ...
            e = $.getElement(e);
            var i = $.getElementOffset(e), n = $.getElementSize(e);
            return t.x >= i.x && t.x < i.x + n.x && t.y < i.y + n.y && t.y >= i.y
        }, getEvent: function (e) {
            $.getEvent = e ? function (e) {
                return e
            } : function () {
                return window.event
            };
            ...
            if (void 0 !== window.scrollTo) $.setPageScroll = function (e) {
                ...
                if ((i = $.getPageScroll()).x !== t.x && i.y !== t.y) {
                    $.setPageScroll = function (e) {
                        document.documentElement.scrollLeft = e.x;
                        document.documentElement.scrollTop = e.y
                    };
            ...
            var t = document.createElement(e), i = t.style;
            ...
            $.Browser.vendor == $.BROWSERS.IE && $.Browser.version < 7 && ($.makeTransparentImage = function (e) {
                var t = $.makeNeutralElement("img"), i = null;
            ...
            return $.makeTransparentImage(e)
        }, setElementOpacity: function (e, t, i) {
            var n;
            e = $.getElement(e);
            i && !$.Browser.alpha && (t = Math.round(t));
            if ($.Browser.opacity) e.style.opacity = t < 1 ? t : ""; else if (t < 1) {
            ...
            Array.prototype.indexOf ? this.indexOf = function (e, t, i) {
                ...
                if (0 === (o = e.length) || o <= r) return -1;
                r < 0 && (r = o - Math.abs(r));
                for (n = r; n < o; n++) if (e[n] === t) return n;
                return -1
            };
            return this.indexOf(e, t, i)
        }, removeClass: function (e, t) {
            var i, n, o = [];
            i = (e = $.getElement(e)).className.split(/\s+/);
            ...
            var a = $.createAjaxRequest("file:" === s);
            if (!$.isFunction(i)) throw new Error("makeAjaxRequest requires a success callback");
            a.onreadystatechange = function () {
                if (4 == a.readyState) {
                    a.onreadystatechange = function () {
                    };
                    if (200 <= a.status && a.status < 300 || 0 === a.status && "http:" !== s && "https:" !== s) i(a); else {
                        $.console.log("AJAX request returned %d: %s", a.status, e);
                        $.isFunction(n) && n(a)
                    }
                }
            };
            try {
                a.open("GET", e, !0);
                r && (a.responseType = r);
                if (o) for (var l in o) Object.prototype.hasOwnProperty.call(o, l) && o[l] && a.setRequestHeader(l, o[l]);
                t && (a.withCredentials = !0);
                a.send(null)
            } catch (t) {
                var h = t.message;
                $.Browser.vendor == $.BROWSERS.IE && $.Browser.version < 10 && void 0 !== t.number && -2147024891 == t.number && (h += "\nSee http://msdn.microsoft.com/en-us/library/ms537505(v=vs.85).aspx#xdomain");
                $.console.log("%s while making AJAX request: %s", t.name, h);
                a.onreadystatechange = function () {
                };
                if (window.XDomainRequest) {
                    ...
                    if (c) {
                        c.onload = function (e) {
                            $.isFunction(i) && i({responseText: c.responseText, status: 200, statusText: "OK"})
                        };
                ...
                } else $.isFunction(n) && n(a, t)
            }
            return a
        }, jsonp: function (e) {
            var i, t = e.url, n = document.head || document.getElementsByTagName("head")[0] || document.documentElement,
                o = e.callbackName || "openseadragon" + $.now(), r = window[o], s = "$1" + o + "$2",
                a = e.param || "callback", l = e.callback;
            t = t.replace(/(\=)\?(&|$)|\?\?/i, s);
            t += (/\?/.test(t) ? "&" : "?") + a + "=" + o;
            window[o] = function (e) {
    ...
    !function () {
        ...
        switch (navigator.appName) {
            case"Microsoft Internet Explorer":
                ...
                break;
            case"Netscape":
                if (window.addEventListener) if (0 <= t.indexOf("Firefox")) {
                    $.Browser.vendor = $.BROWSERS.FIREFOX;
                    $.Browser.version = parseFloat(t.substring(t.indexOf("Firefox") + 8))
                } else if (0 <= t.indexOf("Safari")) {
                    $.Browser.vendor = 0 <= t.indexOf("Chrome") ? $.BROWSERS.CHROME : $.BROWSERS.SAFARI;
                    $.Browser.version = parseFloat(t.substring(t.substring(0, t.indexOf("Safari")).lastIndexOf("/") + 1, t.indexOf("Safari")))
        ...
        for (o = 0; o < r.length; o++) if (0 < (n = (i = r[o]).indexOf("="))) {
            var s = i.substring(0, n), a = i.substring(n + 1);
            try {
...
!function (r) {
    ...
    r.EventSource.prototype = {
        addOnceHandler: function (t, i, e, n) {
            ...
            var n = this.events[e];
            n || (this.events[e] = n = []);
            t && r.isFunction(t) && (n[n.length] = {handler: t, userData: i || null})
...
!function (v) {
    var h = [];
    var f = {};
    v.MouseTracker = function (e) {
        h.push(this);
        var t = arguments;
        v.isPlainObject(e) || (e = {element: t[0], clickTimeThreshold: t[1], clickDistThreshold: t[2]});
        this.hash = Math.random();
        this.element = v.getElement(e.element);
        this.clickTimeThreshold = e.clickTimeThreshold || v.DEFAULT_SETTINGS.clickTimeThreshold;
        this.clickDistThreshold = e.clickDistThreshold || v.DEFAULT_SETTINGS.clickDistThreshold;
        this.dblClickTimeThreshold = e.dblClickTimeThreshold || v.DEFAULT_SETTINGS.dblClickTimeThreshold;
        this.dblClickDistThreshold = e.dblClickDistThreshold || v.DEFAULT_SETTINGS.dblClickDistThreshold;
        ...
        f[this.hash] = {
            click: function (e) {
                t = e, o.clickHandler && v.cancelEvent(t);
                var t
            },
            dblclick: function (e) {
                t = e, o.dblClickHandler && v.cancelEvent(t);
                var t
            },
            keydown: function (e) {
                !function (e, t) {
            ...
            mouseover: function (e) {
                !function (e, t) {
                    if ((t = v.getEvent(t)).currentTarget === t.relatedTarget || x(t.currentTarget, t.relatedTarget)) return;
                    S(e, t)
                }(o, e)
            },
            mouseout: function (e) {
            ...
            mousedown: function (e) {
                !function (e, t) {
                    ...
                    t = v.getEvent(t);
                    i = {
                        id: v.MouseTracker.mousePointerId,
                        type: "mouse",
                        isPrimary: !0,
                        currentPos: g(t),
                        currentTime: v.now()
                    };
                    if (V(e, t, [i], P(t.button))) {
                        v.stopEvent(t);
                        u(e, "mouse")
                    }
                    (e.clickHandler || e.dblClickHandler || e.pressHandler || e.dragHandler || e.dragEndHandler) && v.cancelEvent(t)
                }(o, e)
            },
            mouseup: function (e) {
                R(o, e)
            ...
            touchstart: function (e) {
                !function (e, t) {
                    var i, n, o, r, s = t.changedTouches.length, a = [], l = e.getActivePointersListByType("touch");
                    i = v.now();
                    if (l.getLength() > t.touches.length - s) {
                        v.console.warn("Tracked touch contact count doesn't match event.touches.length. Removing all tracked touch pointers.");
                        b(e, t, l)
                    }
                    for (n = 0; n < s; n++) a.push({
                        id: t.changedTouches[n].identifier,
                        type: "touch",
                        currentPos: g(t.changedTouches[n]),
                        currentTime: i
                    });
                    N(e, t, a);
                    for (n = 0; n < h.length; n++) if (h[n] !== e && h[n].isTracking() && x(h[n].element, e.element)) {
                        r = [];
                        for (o = 0; o < s; o++) r.push({
                            id: t.changedTouches[o].identifier,
                            type: "touch",
                            currentPos: g(t.changedTouches[o]),
                            currentTime: i
                        });
                        N(h[n], t, r)
                    }
            ...
            touchcancel: function (e) {
                i = e, n = (t = o).getActivePointersListByType("touch"), b(t, i, n);
                var t, i, n
            },
            ...
            pointerupcaptured: function (e) {
                !function (e, t) {
                    e.getActivePointersListByType(p(t)).getById(t.pointerId) && M(e, t);
                    v.stopEvent(t)
                }(o, e)
            },
            pointermovecaptured: function (e) {
                !function (e, t) {
                    e.getActivePointersListByType(p(t)).getById(t.pointerId) && H(e, t);
                    v.stopEvent(t)
                }(o, e)
            },
            tracking: !1,
    ...
    v.MouseTracker.prototype = {
        destroy: function () {
            var e;
            t(this);
            this.element = null;
            for (e = 0; e < h.length; e++) if (h[e] === this) {
                h.splice(e, 1);
                break
            }
            f[this.hash] = null;
            ...
            return f[this.hash].tracking
        }, setTracking: function (e) {
            (e ? function (e) {
                var t, i, n = f[e.hash];
                if (!n.tracking) {
                    for (i = 0; i < v.MouseTracker.subscribeEvents.length; i++) {
                        t = v.MouseTracker.subscribeEvents[i];
                        v.addEvent(e.element, t, n[t], !1)
                    }
                    o(e);
                    n.tracking = !0
                }
            ...
            var t = f[this.hash];
            var i = [];
            for (var n = 0; n < t.activePointersLists.length; ++n) t.activePointersLists[n].type !== e && i.push(t.activePointersLists[n]);
            return i
        }, getActivePointersListByType: function (e) {
            var t, i, n = f[this.hash], o = n.activePointersLists.length;
            for (t = 0; t < o; t++) if (n.activePointersLists[t].type === e) return n.activePointersLists[t];
            i = new v.MouseTracker.GesturePointList(e);
            n.activePointersLists.push(i);
            return i
        }, getActivePointerCount: function () {
            var e, t = f[this.hash], i = t.activePointersLists.length, n = 0;
    ...
    v.MouseTracker.resetAllMouseTrackers = function () {
        for (var e = 0; e < h.length; e++) if (h[e].isTracking()) {
            h[e].setTracking(!1);
            h[e].setTracking(!0)
        }
    };
    v.MouseTracker.gesturePointVelocityTracker = (l = [], c = s = 0, {
        addPoint: function (e, t) {
            var i = r(e, t);
            l.push({guid: i, gPoint: t, lastPos: t.currentPos});
            if (1 === l.length) {
                c = v.now();
                s = window.setInterval(n, 50)
            }
        }, removePoint: function (e, t) {
            var i, n = r(e, t), o = l.length;
            for (i = 0; i < o; i++) if (l[i].guid === n) {
                l.splice(i, 1);
                0 == --o && window.clearInterval(s);
                break
            }
        }
    });
    ...
    function n() {
        var e, t, i, n, o, r, s = l.length, a = v.now();
        n = a - c;
        c = a;
        for (e = 0; e < s; e++) {
            ...
            r = 1e3 * o / (1 + n);
            i.speed = .75 * r + .25 * i.speed
        }
    }

    var l, s, c;
    v.MouseTracker.captureElement = document;
    v.MouseTracker.wheelEventName = v.Browser.vendor == v.BROWSERS.IE && 8 < v.Browser.version || "onwheel" in document.createElement("div") ? "wheel" : void 0 !== document.onmousewheel ? "mousewheel" : "DOMMouseScroll";
    v.MouseTracker.supportsMouseCapture = (e = document.createElement("div"), v.isFunction(e.setCapture) && v.isFunction(e.releaseCapture));
    var e;
    v.MouseTracker.subscribeEvents = ["click", "dblclick", "keydown", "keyup", "keypress", "focus", "blur", v.MouseTracker.wheelEventName];
    "DOMMouseScroll" == v.MouseTracker.wheelEventName && v.MouseTracker.subscribeEvents.push("MozMousePixelScroll");
    if (window.PointerEvent && (window.navigator.pointerEnabled || v.Browser.vendor !== v.BROWSERS.IE)) {
        v.MouseTracker.havePointerEvents = !0;
        v.MouseTracker.subscribeEvents.push("pointerover", "pointerout", "pointerdown", "pointerup", "pointermove", "pointercancel");
        v.MouseTracker.unprefixedPointerEvents = !0;
        navigator.maxTouchPoints ? v.MouseTracker.maxTouchPoints = navigator.maxTouchPoints : v.MouseTracker.maxTouchPoints = 0;
        v.MouseTracker.haveMouseEnter = !1
    } else if (window.MSPointerEvent && window.navigator.msPointerEnabled) {
        v.MouseTracker.havePointerEvents = !0;
        v.MouseTracker.subscribeEvents.push("MSPointerOver", "MSPointerOut", "MSPointerDown", "MSPointerUp", "MSPointerMove", "MSPointerCancel");
        v.MouseTracker.unprefixedPointerEvents = !1;
        navigator.msMaxTouchPoints ? v.MouseTracker.maxTouchPoints = navigator.msMaxTouchPoints : v.MouseTracker.maxTouchPoints = 0;
        v.MouseTracker.haveMouseEnter = !1
    } else {
        v.MouseTracker.havePointerEvents = !1;
        if (v.Browser.vendor === v.BROWSERS.IE && v.Browser.version < 9) {
            v.MouseTracker.subscribeEvents.push("mouseenter", "mouseleave");
            v.MouseTracker.haveMouseEnter = !0
        } else {
            v.MouseTracker.subscribeEvents.push("mouseover", "mouseout");
            v.MouseTracker.haveMouseEnter = !1
        }
        v.MouseTracker.subscribeEvents.push("mousedown", "mouseup", "mousemove");
        "ontouchstart" in window && v.MouseTracker.subscribeEvents.push("touchstart", "touchend", "touchmove", "touchcancel");
        "ongesturestart" in window && v.MouseTracker.subscribeEvents.push("gesturestart", "gesturechange");
        v.MouseTracker.mousePointerId = "legacy-mouse";
        v.MouseTracker.maxTouchPoints = 10
    }
    v.MouseTracker.GesturePointList = function (e) {
        this._gPoints = [];
        this.type = e;
        this.buttons = 0;
        this.contacts = 0;
    ...
    v.MouseTracker.GesturePointList.prototype = {
        getLength: function () {
    ...
    function o(e) {
        var t, i = f[e.hash], n = i.activePointersLists.length;
        for (t = 0; t < n; t++) if (0 < i.activePointersLists[t].captureCount) {
            v.removeEvent(v.MouseTracker.captureElement, "mousemove", i.mousemovecaptured, !0);
            v.removeEvent(v.MouseTracker.captureElement, "mouseup", i.mouseupcaptured, !0);
            v.removeEvent(v.MouseTracker.captureElement, v.MouseTracker.unprefixedPointerEvents ? "pointermove" : "MSPointerMove", i.pointermovecaptured, !0);
            v.removeEvent(v.MouseTracker.captureElement, v.MouseTracker.unprefixedPointerEvents ? "pointerup" : "MSPointerUp", i.pointerupcaptured, !0);
            v.removeEvent(v.MouseTracker.captureElement, "touchmove", i.touchmovecaptured, !0);
            v.removeEvent(v.MouseTracker.captureElement, "touchend", i.touchendcaptured, !0);
            i.activePointersLists[t].captureCount = 0
        }
        for (t = 0; t < n; t++) i.activePointersLists.pop()
    }
    ...
    function t(e) {
        ...
        if (n.tracking) {
            for (i = 0; i < v.MouseTracker.subscribeEvents.length; i++) {
                t = v.MouseTracker.subscribeEvents[i];
                v.removeEvent(e.element, t, n[t], !1)
            }
            o(e);
            n.tracking = !1
        }
    ...
    function a(e, t) {
        ...
        if ("pointerevent" === t) return {
            upName: v.MouseTracker.unprefixedPointerEvents ? "pointerup" : "MSPointerUp",
            upHandler: i.pointerupcaptured,
            moveName: v.MouseTracker.unprefixedPointerEvents ? "pointermove" : "MSPointerMove",
    ...
    function u(e, t, i) {
        var n, o = e.getActivePointersListByType(t);
        o.captureCount += i || 1;
        if (1 === o.captureCount) if (v.Browser.vendor === v.BROWSERS.IE && v.Browser.version < 9) e.element.setCapture(!0); else {
            n = a(e, v.MouseTracker.havePointerEvents ? "pointerevent" : t);
            G && $(window.top) && v.addEvent(window.top, n.upName, n.upHandler, !0);
            v.addEvent(v.MouseTracker.captureElement, n.upName, n.upHandler, !0);
            v.addEvent(v.MouseTracker.captureElement, n.moveName, n.moveHandler, !0)
        }
    }
    ...
    function d(e, t, i) {
        var n, o = e.getActivePointersListByType(t);
        o.captureCount -= i || 1;
        if (0 === o.captureCount) if (v.Browser.vendor === v.BROWSERS.IE && v.Browser.version < 9) e.element.releaseCapture(); else {
            n = a(e, v.MouseTracker.havePointerEvents ? "pointerevent" : t);
            G && $(window.top) && v.removeEvent(window.top, n.upName, n.upHandler, !0);
            v.removeEvent(v.MouseTracker.captureElement, n.moveName, n.moveHandler, !0);
            v.removeEvent(v.MouseTracker.captureElement, n.upName, n.upHandler, !0)
        }
    }

    function p(e) {
        var t;
        if (v.MouseTracker.unprefixedPointerEvents) t = e.pointerType; else switch (e.pointerType) {
            case 2:
                t = "touch";
                break;
            case 3:
    ...
    function w(e, t) {
        var i = v.getElementOffset(t);
        return e.minus(i)
    }

    function y(e, t) {
        return new v.Point((e.x + t.x) / 2, (e.y + t.y) / 2)
    }

    function i(e, t) {
        var i = {
            target: (t = v.getEvent(t)).target || t.srcElement,
            type: "wheel",
        ...
        "mousewheel" == v.MouseTracker.wheelEventName ? i.deltaY = -t.wheelDelta / v.DEFAULT_SETTINGS.pixelsPerWheelLine : i.deltaY = t.detail;
        T(e, i, t)
    }
    ...
    function P(e) {
        return v.Browser.vendor === v.BROWSERS.IE && v.Browser.version < 9 ? 1 === e ? 0 : 2 === e ? 2 : 4 === e ? 1 : -1 : e
    }
    ...
    function C(e, t) {
        var i, n, o, r, s = t.changedTouches.length, a = [];
        i = v.now();
        for (n = 0; n < s; n++) a.push({
            id: t.changedTouches[n].identifier,
            type: "touch",
    ...
    function O(e, t) {
        var i, n = t.changedTouches.length, o = [];
        for (i = 0; i < n; i++) o.push({
            id: t.changedTouches[i].identifier,
            type: "touch",
            currentPos: g(t.changedTouches[i]),
            currentTime: v.now()
        });
        j(e, t, o);
        v.cancelEvent(t)
    ...
    function I(e, t) {
        t.currentTarget === t.relatedTarget || x(t.currentTarget, t.relatedTarget) || N(e, t, [{
            id: t.pointerId,
            type: p(t),
    ...
    function k(e, t) {
        t.currentTarget === t.relatedTarget || x(t.currentTarget, t.relatedTarget) || W(e, t, [{
            id: t.pointerId,
            type: p(t),
            isPrimary: t.isPrimary,
            currentPos: g(t),
    ...
    function B(e, t) {
        ...
        (e.clickHandler || e.dblClickHandler || e.pressHandler || e.dragHandler || e.dragEndHandler || e.pinchHandler) && v.cancelEvent(t)
    }
    ...
    function H(e, t) {
        j(e, t, [{id: t.pointerId, type: p(t), isPrimary: t.isPrimary, currentPos: g(t), currentTime: v.now()}])
    }
    ...
    function F(e, t) {
        !function (e, t, i) {
            U(e, t, i, 0);
            W(e, t, i)
        }(e, t, [{id: t.pointerId, type: p(t)}])
    }

    function L(e, t) {
        Object.prototype.hasOwnProperty.call(t, "isPrimary") || (0 === e.getLength() ? t.isPrimary = !0 : t.isPrimary = !1);
        t.speed = 0;
        t.direction = 0;
    ...
    function A(e, t) {
        ...
        if (e.getById(t.id)) {
            i = e.removeById(t.id);
            Object.prototype.hasOwnProperty.call(t, "isPrimary") || (n = e.getPrimary()) || (n = e.getByIndex(0)) && (n.isPrimary = !0)
        } else i = e.getLength();
        return i
    }

    function N(e, t, i) {
        var n, o, r, s = e.getActivePointersListByType(i[0].type), a = i.length;
        for (n = 0; n < a; n++) {
            o = i[n];
            if (r = s.getById(o.id)) {
                r.insideElement = !0;
    ...
    function W(e, t, i) {
        ...
        for (n = 0; n < a; n++) {
            ...
            e.exitHandler && !1 === e.exitHandler({
                eventSource: e,
                pointerType: o.type,
                position: o.currentPos && w(o.currentPos, e.element),
                buttons: s.buttons,
                pointers: e.getActivePointerCount(),
                insideElementPressed: !!r && r.insideElementPressed,
                buttonDownAny: 0 !== s.buttons,
                isTouchEvent: "touch" === o.type,
                originalEvent: t,
                preventDefaultAction: !1,
    ...
    function V(e, t, i, n) {
        var o, r, s, a = f[e.hash], l = e.getActivePointersListByType(i[0].type), h = i.length;
        void 0 !== t.buttons ? l.buttons = t.buttons : v.Browser.vendor === v.BROWSERS.IE && v.Browser.version < 9 ? 0 === n ? l.buttons += 1 : 1 === n ? l.buttons += 4 : 2 === n ? l.buttons += 2 : 3 === n ? l.buttons += 8 : 4 === n ? l.buttons += 16 : 5 === n && (l.buttons += 32) : 0 === n ? l.buttons |= 1 : 1 === n ? l.buttons |= 4 : 2 === n ? l.buttons |= 2 : 3 === n ? l.buttons |= 8 : 4 === n ? l.buttons |= 16 : 5 === n && (l.buttons |= 32);
        var c = e.getActivePointersListsExceptType(i[0].type);
        for (o = 0; o < c.length; o++) b(e, t, c[o]);
        if (0 !== n) {
            e.nonPrimaryPressHandler && !1 === e.nonPrimaryPressHandler({
                eventSource: e,
                pointerType: i[0].type,
                position: w(i[0].currentPos, e.element),
                button: n,
                buttons: l.buttons,
        ...
        for (o = 0; o < h; o++) {
            ...
            if (s = l.getById(r.id)) {
                ...
                s.insideElement = !0;
                s.contactPos = r.currentPos;
                s.contactTime = r.currentTime;
            ...
            l.addContact();
            (e.dragHandler || e.dragEndHandler || e.pinchHandler) && v.MouseTracker.gesturePointVelocityTracker.addPoint(e, r);
            if (1 === l.contacts) e.pressHandler && !1 === e.pressHandler({
                eventSource: e,
                pointerType: r.type,
                position: w(r.contactPos, e.element),
                buttons: l.buttons,
                isTouchEvent: "touch" === r.type,
                originalEvent: t,
                preventDefaultAction: !1,
                userData: e.userData
            }) && v.cancelEvent(t); else if (2 === l.contacts && e.pinchHandler && "touch" === r.type) {
    ...
    function U(e, t, i, n) {
        var o, r, s, a, l, h, c = f[e.hash], u = e.getActivePointersListByType(i[0].type), d = i.length, p = !1, g = !1;
        void 0 !== t.buttons ? u.buttons = t.buttons : v.Browser.vendor === v.BROWSERS.IE && v.Browser.version < 9 ? 0 === n ? --u.buttons : 1 === n ? u.buttons -= 4 : 2 === n ? u.buttons -= 2 : 3 === n ? u.buttons -= 8 : 4 === n ? u.buttons -= 16 : 5 === n && (u.buttons -= 32) : 0 === n ? u.buttons ^= -2 : 1 === n ? u.buttons ^= -5 : 2 === n ? u.buttons ^= -3 : 3 === n ? u.buttons ^= -9 : 4 === n ? u.buttons ^= -17 : 5 === n && (u.buttons ^= -33);
        if (0 !== n) {
            ...
            var m = e.getActivePointersListByType("mouse");
            b(e, t, m);
            return !1
        }
        if (void 0 === i[0].currentPos) {
            b(e, t, u);
            return !1
        }
        for (s = 0; s < d; s++) {
            a = i[s];
            if (l = u.getById(a.id)) {
                l.captured && (g = p = !(l.captured = !1));
                l.lastPos = l.currentPos;
                l.lastTime = l.currentTime;
                l.currentPos = a.currentPos;
                l.currentTime = a.currentTime;
                l.insideElement || A(u, l);
                o = l.currentPos;
                r = l.currentTime;
                if (g) {
                    u.removeContact();
                    (e.dragHandler || e.dragEndHandler || e.pinchHandler) && v.MouseTracker.gesturePointVelocityTracker.removePoint(e, l);
                    if (0 === u.contacts) {
                        e.releaseHandler && !1 === e.releaseHandler({
                            eventSource: e,
                            pointerType: l.type,
                            position: w(o, e.element),
                            buttons: u.buttons,
                        ...
                        e.dragEndHandler && !l.currentPos.equals(l.contactPos) && !1 === e.dragEndHandler({
                            eventSource: e,
                            pointerType: l.type,
                            position: w(l.currentPos, e.element),
                            speed: l.speed,
                        ...
                        if ((e.clickHandler || e.dblClickHandler) && l.insideElement) {
                            h = r - l.contactTime <= e.clickTimeThreshold && l.contactPos.distanceTo(o) <= e.clickDistThreshold;
                            ...
                            if (e.dblClickHandler && h) {
                                u.clicks++;
                                if (1 === u.clicks) {
                                    c.lastClickPos = o;
                                    c.dblClickTimeOut = setTimeout(function () {
                                        u.clicks = 0
                                    }, e.dblClickTimeThreshold)
                                } else if (2 === u.clicks) {
                                    clearTimeout(c.dblClickTimeOut);
                                    u.clicks = 0;
                                    c.lastClickPos.distanceTo(o) <= e.dblClickDistThreshold && !1 === e.dblClickHandler({
                                        eventSource: e,
                                        pointerType: l.type,
                                        position: w(l.currentPos, e.element),
                                        shift: t.shiftKey,
                    ...
                    } else if (2 === u.contacts && e.pinchHandler && "touch" === l.type) {
                        c.pinchGPoints = u.asArray();
                        c.lastPinchDist = c.currentPinchDist = c.pinchGPoints[0].currentPos.distanceTo(c.pinchGPoints[1].currentPos);
                        c.lastPinchCenter = c.currentPinchCenter = y(c.pinchGPoints[0].currentPos, c.pinchGPoints[1].currentPos)
                    }
                } else e.releaseHandler && !1 === e.releaseHandler({
                    eventSource: e,
                    pointerType: l.type,
                    position: w(o, e.element),
                    buttons: u.buttons,
    ...
    function j(n, o, r) {
        var e, t, i, s, a, l = f[n.hash], h = n.getActivePointersListByType(r[0].type), c = r.length;
        void 0 !== o.buttons && (h.buttons = o.buttons);
        for (e = 0; e < c; e++) {
            t = r[e];
            if (i = h.getById(t.id)) {
                Object.prototype.hasOwnProperty.call(t, "isPrimary") && (i.isPrimary = t.isPrimary);
                i.lastPos = i.currentPos;
                i.lastTime = i.currentTime;
                i.currentPos = t.currentPos;
                i.currentTime = t.currentTime
            } else {
                t.captured = !1;
                t.insideElementPressed = !1;
                t.insideElement = !0;
                L(h, t)
            }
        }
        if (n.stopHandler && "mouse" === r[0].type) {
            clearTimeout(n.stopTimeOut);
            n.stopTimeOut = setTimeout(function () {
                e = n, t = o, i = r[0].type, e.stopHandler && e.stopHandler({
                    eventSource: e,
                    pointerType: i,
                    position: m(t, e.element),
        ...
        if (0 === h.contacts) n.moveHandler && !1 === n.moveHandler({
            eventSource: n,
            pointerType: r[0].type,
            position: w(r[0].currentPos, n.element),
            buttons: h.buttons,
            isTouchEvent: "touch" === r[0].type,
            originalEvent: o,
            preventDefaultAction: !1,
            userData: n.userData
        }) && v.cancelEvent(o); else if (1 === h.contacts) {
            if (n.moveHandler) {
                i = h.asArray()[0];
                !1 === n.moveHandler({
                    eventSource: n,
                    pointerType: i.type,
                    position: w(i.currentPos, n.element),
                    buttons: h.buttons,
            ...
            if (n.dragHandler) {
                a = (i = h.asArray()[0]).currentPos.minus(i.lastPos);
                !1 === n.dragHandler({
                    eventSource: n,
                    pointerType: i.type,
                    position: w(i.currentPos, n.element),
        ...
        } else if (2 === h.contacts) {
            if (n.moveHandler) {
                s = h.asArray();
                !1 === n.moveHandler({
                    eventSource: n,
                    pointerType: s[0].type,
                    position: w(y(s[0].currentPos, s[1].currentPos), n.element),
                    buttons: h.buttons,
            ...
            if (n.pinchHandler && "touch" === r[0].type && (a = l.pinchGPoints[0].currentPos.distanceTo(l.pinchGPoints[1].currentPos)) != l.currentPinchDist) {
                l.lastPinchDist = l.currentPinchDist;
                ...
                !1 === n.pinchHandler({
                    ...
                    lastCenter: w(l.lastPinchCenter, n.element),
                    center: w(l.currentPinchCenter, n.element),
...
!function (o) {
    o.ControlDock = function (e) {
        ...
        for (i = 0; i < n.length; i++) {
            t = n[i];
            this.controls[t] = o.makeNeutralElement("div");
    ...
    o.ControlDock.prototype = {
        addControl: function (e, t) {
            ...
            var t = n(this, e = o.getElement(e));
            if (0 <= t) {
                this.controls[t].destroy();
...
OpenSeadragon.Placement = OpenSeadragon.freezeObject({
    CENTER: 0,
    TOP_LEFT: 1,
    TOP: 2,
    TOP_RIGHT: 3,
...
!function (m) {
    ...
    m.Viewer = function (e) {
        ...
        this.addHandler("open-failed", function (e) {
            var t = m.getString("Errors.OpenFailed", e.eventSource, e.message);
            n._showMessage(t)
        });
        ...
        this.outerTracker = new m.MouseTracker({
            ...
            exitHandler: m.delegate(this, k)
        });
        this.toolbar && (this.toolbar = new m.ControlDock({element: this.toolbar}));
        this.bindStandardControls();
        c[this.hash].prevContainerSize = u(this.container);
        ...
        this.world.addHandler("add-item", function (e) {
            ...
            n._updateRequestId || (n._updateRequestId = r(n, B))
        });
        ...
        this.imageLoader = new m.ImageLoader({jobLimit: this.imageLoaderLimit, timeout: e.timeout});
        ...
        if (!this.drawer.canRotate()) {
            if (this.rotateLeft) {
                t = this.buttons.buttons.indexOf(this.rotateLeft);
                this.buttons.buttons.splice(t, 1);
                this.buttons.element.removeChild(this.rotateLeft.element)
            }
            if (this.rotateRight) {
                t = this.buttons.buttons.indexOf(this.rotateRight);
                this.buttons.buttons.splice(t, 1);
    ...
    m.extend(m.Viewer.prototype, m.EventSource.prototype, m.ControlDock.prototype, {
        isOpen: function () {
            ...
            var o = this;
            this.close();
            if (i) if (this.sequenceMode && m.isArray(i)) {
                ...
                if (i.length) {
                    ...
                    function l() {
                        if (r + s === n) if (r) {
                            ...
                            if (o.overlays && !o.preserveOverlays) for (var t = 0; t < o.overlays.length; t++) o.currentOverlays[t] = d(o, o.overlays[t]);
                            o._drawOverlays();
                            o._opening = !1;
                    ...
                    function t(i) {
                        m.isPlainObject(i) && i.tileSource || (i = {tileSource: i});
                        if (void 0 !== i.index) {
            ...
            if (e) {
                ...
                this.element.style.height = m.getWindowSize().y + "px";
                this.element.style.width = m.getWindowSize().x + "px";
            ...
            var o = this;
            i.replace && (i.replaceItem = o.world.getItemAt(i.index));
            this._hideMessage();
            ...
            function t(e) {
                for (var t = 0; t < o._loadQueue.length; t++) if (o._loadQueue[t] === n) {
                    o._loadQueue.splice(t, 1);
                    break
                }
                0 === o._loadQueue.length && r(n);
                o.raiseEvent("add-item-failed", e);
                i.error && i.error(e)
            }
            ...
            function r(e) {
                if (o.collectionMode) {
                    o.world.arrange({
                        ...
                        rows: o.collectionRows,
                        columns: o.collectionColumns,
                        layout: o.collectionLayout,
                        tileSize: o.collectionTileSize,
                        tileMargin: o.collectionTileMargin
                    });
                    o.world.setAutoRefigureSizes(!0)
                }
            }
            ...
            if (m.isArray(i.tileSource)) setTimeout(function () {
                ...
                !function (n, o, r, s, a) {
                    var l = n;
                    if ("string" == m.type(o)) if (o.match(/^\s*<.*>\s*$/)) o = m.parseXml(o); else if (o.match(/^\s*[\{\[].*[\}\]]\s*$/)) try {
                        var e = m.parseJSON(o);
                        o = e
                    } catch (e) {
                    }
                    ...
                    function h(e, t) {
                        if (e.ready) s(e); else {
                            ...
                            e.addHandler("open-failed", function (e) {
                                a({message: e.message, source: t})
                            })
                        }
                    }

                    setTimeout(function () {
                        if ("string" == m.type(o)) (o = new m.TileSource({
                            url: o,
                            crossOriginPolicy: void 0 !== r.crossOriginPolicy ? r.crossOriginPolicy : n.crossOriginPolicy,
                            ajaxWithCredentials: n.ajaxWithCredentials,
                            ajaxHeaders: n.ajaxHeaders,
                            useCanvas: n.useCanvas,
                            success: function (e) {
                                s(e.tileSource)
                            }
                        })).addHandler("open-failed", function (e) {
                            a(e)
                        }); else if (m.isPlainObject(o) || o.nodeType) {
                            void 0 !== o.crossOriginPolicy || void 0 === r.crossOriginPolicy && void 0 === n.crossOriginPolicy || (o.crossOriginPolicy = void 0 !== r.crossOriginPolicy ? r.crossOriginPolicy : n.crossOriginPolicy);
                            void 0 === o.ajaxWithCredentials && (o.ajaxWithCredentials = n.ajaxWithCredentials);
                            void 0 === o.useCanvas && (o.useCanvas = n.useCanvas);
                            if (m.isFunction(o.getTileUrl)) {
                                var e = new m.TileSource(o);
                                e.getTileUrl = o.getTileUrl;
                                s(e)
                            } else {
                                var t = m.TileSource.determineType(l, o);
                                if (!t) {
                                    a({message: "Unable to load TileSource", source: o});
                                    return
                                }
                                var i = t.prototype.configure.apply(l, [o]);
                                h(new t(i), o)
                            }
                        } else h(o, o)
                    })
            ...
            function s() {
                var e, t, i;
                for (; o._loadQueue.length && (e = o._loadQueue[0]).tileSource;) {
                    o._loadQueue.splice(0, 1);
                    if (e.options.replace) {
                        var n = o.world.getIndexOfItem(e.options.replaceItem);
                        -1 != n && (e.options.index = n);
                        o.world.removeItem(e.options.replaceItem)
                    }
                    t = new m.TiledImage({
                        viewer: o,
                        source: e.tileSource,
                        ...
                        springStiffness: o.springStiffness,
                        animationTime: o.animationTime,
                        minZoomImageRatio: o.minZoomImageRatio,
                        wrapHorizontal: o.wrapHorizontal,
                        wrapVertical: o.wrapVertical,
                        immediateRender: o.immediateRender,
                        blendTime: o.blendTime,
                        alwaysBlend: o.alwaysBlend,
                        minPixelRatio: o.minPixelRatio,
                    ...
                    o.collectionMode && o.world.setAutoRefigureSizes(!1);
                    o.world.addItem(t, {index: e.options.index});
                    0 === o._loadQueue.length && r(e);
                    1 !== o.world.getItemCount() || o.preserveViewport || o.viewport.goHome(!0);
                    if (o.navigator) {
                        i = m.extend({}, e.options, {replace: !1, originalTiledImage: t, tileSource: e.tileSource});
                        o.navigator.addTiledImage(i)
                    }
            ...
            var t = m.extend({}, e, {tileSource: {type: "image", url: e.url}});
            delete t.url;
            ...
            var e = m.delegate(this, v), t = m.delegate(this, f), i = m.delegate(this, $), n = m.delegate(this, G),
                o = this.navImages, r = !0;
            if (this.showSequenceControl) {
                ...
                this.previousButton = new m.Button({
                    ...
                    srcRest: D(this.prefixUrl, o.previous.REST),
                    srcGroup: D(this.prefixUrl, o.previous.GROUP),
                    srcHover: D(this.prefixUrl, o.previous.HOVER),
                    srcDown: D(this.prefixUrl, o.previous.DOWN),
                    onRelease: n,
                    onFocus: e,
                    onBlur: t
                });
                this.nextButton = new m.Button({
                    ...
                    srcRest: D(this.prefixUrl, o.next.REST),
                    srcGroup: D(this.prefixUrl, o.next.GROUP),
                    srcHover: D(this.prefixUrl, o.next.HOVER),
                    srcDown: D(this.prefixUrl, o.next.DOWN),
                    onRelease: i,
                    onFocus: e,
                    onBlur: t
                });
            ...
            var e = m.delegate(this, M), t = m.delegate(this, H), i = m.delegate(this, F), n = m.delegate(this, z),
                o = m.delegate(this, L), r = m.delegate(this, N), s = m.delegate(this, W), a = m.delegate(this, V),
                l = m.delegate(this, U), h = m.delegate(this, j), c = m.delegate(this, v), u = m.delegate(this, f),
            ...
            if (this.showNavigationControl) {
                ...
                this.showFlipControl && p.push(this.flipButton = new m.Button({
                    ...
                    srcRest: D(this.prefixUrl, d.flip.REST),
                    srcGroup: D(this.prefixUrl, d.flip.GROUP),
                    srcHover: D(this.prefixUrl, d.flip.HOVER),
                    srcDown: D(this.prefixUrl, d.flip.DOWN),
                    onRelease: h,
                    onFocus: c,
                    onBlur: u
                }));
                if (g) {
                    this.buttons = new m.ButtonGroup({
                        buttons: p,
                        clickTimeThreshold: this.clickTimeThreshold,
                        clickDistThreshold: this.clickDistThreshold
                    });
                    ...
                    this.toolbar ? this.toolbar.addControl(this.navControl, {anchor: this.navigationControlAnchor || m.ControlAnchor.TOP_LEFT}) : this.addControl(this.navControl, {anchor: this.navigationControlAnchor || m.ControlAnchor.TOP_LEFT})
                }
            }
            return this
            ...
            var o;
            o = m.isPlainObject(e) ? e : {element: e, location: t, placement: i, onDraw: n};
            e = m.getElement(o.element);
            if (0 <= s(this.currentOverlays, e)) return this;
            var r = d(this, o);
            this.currentOverlays.push(r);
            r.drawHTML(this.overlaysContainer, this.viewport);
            this.raiseEvent("add-overlay", {element: e, location: o.location, placement: o.placement});
            return this
            ...
            var t;
            e = m.getElement(e);
            return 0 <= (t = s(this.currentOverlays, e)) ? this.currentOverlays[t] : null
            ...
            if (this.sequenceMode) {
                ...
                if (this.tileSources.length && 1 < this.tileSources.length) {
    ...
    function d(e, t) {
        ...
        if (t.element) i = m.getElement(t.element); else {
            ...
            i.id = n;
            m.addClass(i, t.className ? t.className : "openseadragon-overlay")
        }
        var o = t.location;
        var r = t.width;
        var s = t.height;
        if (!o) {
            ...
            var l = t.y;
            if (void 0 !== t.px) {
                var h = e.viewport.imageToViewportRectangle(new m.Rect(t.px, t.py, r || 0, s || 0));
                a = h.x;
                l = h.y;
                r = void 0 !== r ? h.width : void 0;
                s = void 0 !== s ? h.height : void 0
            }
            o = new m.Point(a, l)
        }
        var c = t.placement;
        c && "string" === m.type(c) && (c = m.Placement[t.placement.toUpperCase()]);
        ...
        m.requestAnimationFrame(function () {
            !function (e) {
                ...
                if (e.controlsShouldFade) {
                    ...
                    n = Math.min(1, n);
                    n = Math.max(0, n);
                    for (o = e.controls.length - 1; 0 <= o; o--) e.controls[o].autoFade && e.controls[o].setOpacity(n);
                    0 < n && a(e)
                }
            }(e)
        })
    ...
    function l(e) {
        ...
        if (t.preventDefaultAction || e.ctrl || e.alt || e.meta) return !0;
        switch (e.keyCode) {
            case 38:
    ...
    function T(e) {
        ...
        if (!i.preventDefaultAction && this.viewport) {
            ...
            if (this.constrainDuringPan) {
                ...
                var r = this.viewport.getConstrainedBounds();
                this.viewport.centerSpringX.target.value -= n.x;
                this.viewport.centerSpringY.target.value -= n.y;
                o.x != r.x && (e.delta.x = 0);
                o.y != r.y && (e.delta.y = 0)
    ...
    function x(e) {
        if (!e.preventDefaultAction && this.viewport) {
            ...
            if (t.flickEnabled && e.speed >= t.flickMinSpeed) {
                ...
                var r = this.viewport.pointFromPixel(new m.Point(o.x - i, o.y - n));
    ...
    function E(e) {
        window.location != window.parent.location && m.MouseTracker.resetAllMouseTrackers();
    ...
    function C(e) {
        var t, i, n;
        if (!e.preventDefaultAction && this.viewport) {
            if ((t = this.gestureSettingsByDeviceType(e.pointerType)).pinchToZoom) {
            ...
            if (t.pinchRotate) {
                ...
                var r = Math.atan2(e.gesturePoints[0].lastPos.y - e.gesturePoints[1].lastPos.y, e.gesturePoints[0].lastPos.x - e.gesturePoints[1].lastPos.x);
    ...
    function O(e) {
        ...
        if ((n = m.now()) - this._lastScrollTime > this.minScrollDeltaTime) {
            ...
            this.viewport.flipped && (e.position.x = this.viewport.getContainerSize().x - e.position.x);
            if (!e.preventDefaultAction && this.viewport && (t = this.gestureSettingsByDeviceType(e.pointerType)).scrollToZoom) {
                i = Math.pow(this.zoomPerScroll, e.scroll);
            ...
            if (t && t.scrollToZoom) return !1
        } else if ((t = this.gestureSettingsByDeviceType(e.pointerType)) && t.scrollToZoom) return !1
    }
    ...
    function B(e) {
        !function (e) {
            ...
            if (c[e.hash].animating && !h) {
                ...
                c[e.hash].mouseInside || p(e)
            }
            c[e.hash].animating = h
        }(e);
        e.isOpen() ? e._updateRequestId = r(e, B) : e._updateRequestId = !1
    }
    ...
    function t() {
        ...
        if (c[this.hash].zooming && this.viewport) {
            ...
            i = Math.pow(c[this.hash].zoomFactor, t / 1e3);
...
!function (c) {
    c.Navigator = function (i) {
        var e, t, n = i.viewer, o = this;
        if (i.id) {
            this.element = document.getElementById(i.id);
            i.controlOptions = {anchor: c.ControlAnchor.NONE, attachToViewer: !1, autoFade: !1}
        } else {
            i.id = "navigator-" + c.now();
            this.element = c.makeNeutralElement("div");
            i.controlOptions = {anchor: c.ControlAnchor.TOP_RIGHT, attachToViewer: !0, autoFade: i.autoFade};
            if (i.position) if ("BOTTOM_RIGHT" == i.position) i.controlOptions.anchor = c.ControlAnchor.BOTTOM_RIGHT; else if ("BOTTOM_LEFT" == i.position) i.controlOptions.anchor = c.ControlAnchor.BOTTOM_LEFT; else if ("TOP_RIGHT" == i.position) i.controlOptions.anchor = c.ControlAnchor.TOP_RIGHT; else if ("TOP_LEFT" == i.position) i.controlOptions.anchor = c.ControlAnchor.TOP_LEFT; else if ("ABSOLUTE" == i.position) {
                i.controlOptions.anchor = c.ControlAnchor.ABSOLUTE;
        ...
        (i = c.extend(!0, {sizeRatio: c.DEFAULT_SETTINGS.navigatorSizeRatio}, i, {
        ...
        })).minPixelRatio = this.minPixelRatio = n.minPixelRatio;
        c.setElementTouchActionNone(this.element);
        this.borderWidth = 2;
        this.fudge = new c.Point(1, 1);
        this.totalBorderWidths = new c.Point(2 * this.borderWidth, 2 * this.borderWidth).minus(this.fudge);
        i.controlOptions.anchor != c.ControlAnchor.NONE && function (e, t) {
            e.margin = "0px";
        ...
        this.displayRegion = c.makeNeutralElement("div");
        ...
        this.displayRegionContainer = c.makeNeutralElement("div");
        this.displayRegionContainer.id = this.element.id + "-displayregioncontainer";
        this.displayRegionContainer.className = "displayregioncontainer";
        this.displayRegionContainer.style.width = "100%";
        this.displayRegionContainer.style.height = "100%";
        n.addControl(this.element, i.controlOptions);
        this._resizeWithViewer = i.controlOptions.anchor != c.ControlAnchor.ABSOLUTE && i.controlOptions.anchor != c.ControlAnchor.NONE;
        if (i.width && i.height) {
            this.setWidth(i.width);
            this.setHeight(i.height)
        } else if (this._resizeWithViewer) {
            e = c.getElementSize(n.element);
            ...
            t = c.getElementSize(this.element);
            this.elementArea = t.x * t.y
        }
        this.oldContainerSize = new c.Point(0, 0);
        c.Viewer.apply(this, [i]);
        this.displayRegionContainer.appendChild(this.displayRegion);
        this.element.getElementsByTagName("div")[0].appendChild(this.displayRegionContainer);

        function r(e) {
            u(o.displayRegionContainer, e);
            u(o.displayRegion, -e);
            o.viewport.setRotation(e)
        }

        if (i.navigatorRotate) {
            r(i.viewer.viewport ? i.viewer.viewport.getRotation() : i.viewer.degrees || 0);
        ...
        this.innerTracker = new c.MouseTracker({
            element: this.element,
            dragHandler: c.delegate(this, a),
            clickHandler: c.delegate(this, s),
            releaseHandler: c.delegate(this, l),
            scrollHandler: c.delegate(this, h)
        });
        this.addHandler("reset-size", function () {
            o.viewport && o.viewport.goHome(!0)
        });
        n.world.addHandler("item-index-change", function (t) {
            window.setTimeout(function () {
                var e = o.world.getItemAt(t.previousIndex);
                o.world.setItemIndex(e, t.newIndex)
            }, 1)
        });
        n.world.addHandler("remove-item", function (e) {
            var t = e.item;
            var i = o._getMatchingItem(t);
            i && o.world.removeItem(i)
        });
        this.update(n.viewport)
    };
    c.extend(c.Navigator.prototype, c.EventSource.prototype, c.Viewer.prototype, {
        updateSize: function () {
            if (this.viewport) {
                var e = new c.Point(0 === this.container.clientWidth ? 1 : this.container.clientWidth, 0 === this.container.clientHeight ? 1 : this.container.clientHeight);
            ...
            if (e && this.viewport) {
                o = e.getBoundsNoRotate(!0);
                r = this.viewport.pixelFromPointNoRotate(o.getTopLeft(), !1);
                s = this.viewport.pixelFromPointNoRotate(o.getBottomRight(), !1).minus(this.totalBorderWidths);
                var a = this.displayRegion.style;
                a.display = this.world.getItemCount() ? "block" : "none";
                a.top = Math.round(r.y) + "px";
                a.left = Math.round(r.x) + "px";
                var l = Math.abs(r.x - s.x);
                var h = Math.abs(r.y - s.y);
                a.width = Math.round(Math.max(l, 0)) + "px";
                a.height = Math.round(Math.max(h, 0)) + "px"
            }
            ...
            return c.Viewer.prototype.addTiledImage.apply(this, [t])
    ...
    s.extend(s, {
        getString: function (e) {
            ...
            if ("string" != typeof (n = r[i[t]])) {
                s.console.log("Untranslated source string:", e);
                n = ""
            }
...
!function (a) {
    ...
    a.Point.prototype = {
        clone: function () {
            ...
            return new a.Point(this.x + e.x, this.y + e.y)
        }, minus: function (e) {
            return new a.Point(this.x - e.x, this.y - e.y)
        }, times: function (e) {
            return new a.Point(this.x * e, this.y * e)
        }, divide: function (e) {
            return new a.Point(this.x / e, this.y / e)
        }, negate: function () {
            return new a.Point(-this.x, -this.y)
            ...
            return new a.Point(e(this.x), e(this.y))
        }, equals: function (e) {
            return e instanceof a.Point && this.x === e.x && this.y === e.y
        }, rotate: function (e, t) {
            t = t || new a.Point(0, 0);
            var i;
            var n;
            if (e % 90 == 0) {
                switch (a.positiveModulo(e, 360)) {
                    case 0:
                        i = 1;
                        n = 0;
                        break;
            ...
            var r = i * (this.x - t.x) - n * (this.y - t.y) + t.x;
            var s = n * (this.x - t.x) + i * (this.y - t.y) + t.y;
...
!function (d) {
    d.TileSource = function (e, t, i, n, o, r) {
        var s = this;
        var a, l, h = arguments;
        a = d.isPlainObject(e) ? e : {
            width: h[0],
            height: h[1],
            tileSize: h[2],
            tileOverlap: h[3],
        ...
        d.EventSource.call(this);
        d.extend(!0, this, a);
        if (!this.success) for (l = 0; l < arguments.length; l++) if (d.isFunction(arguments[l])) {
        ...
        "string" == d.type(e) && (this.url = e);
        if (this.url) {
            this.aspectRatio = 1;
            this.dimensions = new d.Point(10, 10);
            this._tileWidth = 0;
            this._tileHeight = 0;
            this.tileOverlap = 0;
            this.minLevel = 0;
            ...
            this.ready = !0;
            this.aspectRatio = a.width && a.height ? a.width / a.height : 1;
            this.dimensions = new d.Point(a.width, a.height);
            if (this.tileSize) {
            ...
            this.maxLevel = void 0 !== a.maxLevel && null !== a.maxLevel ? a.maxLevel : a.width && a.height ? Math.ceil(Math.log(Math.max(a.width, a.height)) / Math.log(2)) : 0;
            this.success && d.isFunction(this.success) && this.success(this)
        }
    };
    d.TileSource.prototype = {
        getTileSize: function (e) {
            d.console.error("[TileSource.getTileSize] is deprecated. Use TileSource.getTileWidth() and TileSource.getTileHeight() instead");
            ...
            return new d.Point(i, n)
        }, getPixelRatio: function (e) {
            var t = this.dimensions.times(this.getLevelScale(e)), i = 1 / t.x, n = 1 / t.y;
            return new d.Point(i, n)
            ...
            d.console.assert(i, "[TileSource.getTileAtPoint] must be called with a valid point.");
            var n = this.dimensions.x * this.getLevelScale(e);
            var o = t.x * n;
            var r = t.y * n;
            var s = Math.floor(o / this.getTileWidth(e));
            var a = Math.floor(r / this.getTileHeight(e));
            1 <= t.x && (s = this.getNumTiles(e).x - 1);
            ...
            var o = this.dimensions.times(this.getLevelScale(e)), r = this.getTileWidth(e), s = this.getTileHeight(e),
                a = 0 === t ? 0 : r * t - this.tileOverlap, l = 0 === i ? 0 : s * i - this.tileOverlap,
                h = r + (0 === t ? 1 : 2) * this.tileOverlap, c = s + (0 === i ? 1 : 2) * this.tileOverlap, u = 1 / o.x;
            h = Math.min(h, o.x - a);
            c = Math.min(c, o.y - l);
            return n ? new d.Rect(0, 0, h, c) : new d.Rect(a * u, l * u, h * u, c * u)
        }, getImageInfo: function (n) {
            var e, i, o, r, t, s, a, l = this;
            n && -1 < (a = (s = (t = n.split("/"))[t.length - 1]).lastIndexOf(".")) && (t[t.length - 1] = s.slice(0, a));
            i = function (e) {
                "string" == typeof e && (e = d.parseXml(e));
                var t = d.TileSource.determineType(l, e, n);
                if (t) {
                    void 0 === (r = t.prototype.configure.apply(l, [e, n])).ajaxWithCredentials && (r.ajaxWithCredentials = l.ajaxWithCredentials);
                    o = new t(r);
                    l.ready = !0;
                    l.raiseEvent("ready", {tileSource: o})
                } else l.raiseEvent("open-failed", {message: "Unable to load TileSource", source: n})
            };
            if (n.match(/\.js$/)) {
                e = n.split("/").pop().replace(".js", "");
                d.jsonp({url: n, async: !1, callbackName: e, callback: i})
            } else d.makeAjaxRequest({
                url: n,
                ...
                success: function (e) {
                    var t = function (t) {
                        ...
                        {
                            if (!t) throw new Error(d.getString("Errors.Security"));
                            if (200 !== t.status && 0 !== t.status) {
                                o = t.status;
                                e = 404 == o ? "Not Found" : t.statusText;
                                throw new Error(d.getString("Errors.Status", o, e))
                            }
                        }
                        if (n.match(/\s*<.*/)) try {
                            i = t.responseXML && t.responseXML.documentElement ? t.responseXML : d.parseXml(n)
                        } catch (e) {
                            i = t.responseText
                ...
                error: function (e, t) {
                    ...
                    l.raiseEvent("open-failed", {message: i, source: n})
                }
            })
    ...
    d.extend(!0, d.TileSource.prototype, d.EventSource.prototype);
    d.TileSource.determineType = function (e, t, i) {
        var n;
        for (n in OpenSeadragon) if (n.match(/.+TileSource$/) && d.isFunction(OpenSeadragon[n]) && d.isFunction(OpenSeadragon[n].prototype.supports) && OpenSeadragon[n].prototype.supports.call(e, t, i)) return OpenSeadragon[n];
        d.console.error("No TileSource was able to open %s %s", i, t)
    }
}(OpenSeadragon);
!function (g) {
    g.DziTileSource = function (e, t, i, n, o, r, s, a, l) {
        var h, c, u, d;
        d = g.isPlainObject(e) ? e : {
            width: e,
            height: t,
            tileSize: i,
            tileOverlap: n,
        ...
        g.TileSource.apply(this, [d])
    };
    g.extend(g.DziTileSource.prototype, g.TileSource.prototype, {
        supports: function (e, t) {
            var i;
            ...
            var i;
            i = (g.isPlainObject(e) ? p : function (e, t) {
                if (!t || !t.documentElement) throw new Error(g.getString("Errors.Xml"));
                var i, n, o, r, s, a = t.documentElement, l = a.localName || a.tagName,
                    h = t.documentElement.namespaceURI, c = null, u = [];
                if ("Image" == l) try {
                    ...
                    if (!g.imageFormatSupported(c.Image.Format)) throw new Error(g.getString("Errors.ImageFormat", c.Image.Format.toUpperCase()));
                    ...
                    u.length && (c.Image.DisplayRect = u);
                    return p(e, c)
                } catch (e) {
                    throw e instanceof Error ? e : new Error(g.getString("Errors.Dzi"))
                } else {
                    if ("Collection" == l) throw new Error(g.getString("Errors.Dzc"));
                    if ("Error" == l) {
            ...
            if (t && !i.tilesUrl) {
                i.tilesUrl = t.replace(/([^\/]+?)(\.(dzi|xml|js)?(\?[^\/]*)?)?\/?$/, "$1_files/");
            ...
            for (h = c.length - 1; 0 <= h; h--) if (!(e < (n = c[h]).minLevel || e > n.maxLevel)) {
    ...
    function p(e, t) {
        var i, n, o = t.Image, r = o.Url, s = o.Format, a = o.Size, l = o.DisplayRect || [], h = parseInt(a.Width, 10),
            c = parseInt(a.Height, 10), u = parseInt(o.TileSize, 10), d = parseInt(o.Overlap, 10), p = [];
        for (n = 0; n < l.length; n++) {
            i = l[n].Rect;
            p.push(new g.DisplayRect(parseInt(i.X, 10), parseInt(i.Y, 10), parseInt(i.Width, 10), parseInt(i.Height, 10), parseInt(i.MinLevel, 10), parseInt(i.MaxLevel, 10)))
        }
        return g.extend(!0, {
            width: h,
            height: c,
...
!function (h) {
    ...
    h.extend(h.IIIFTileSource.prototype, h.TileSource.prototype, {
        supports: function (e, t) {
            ...
            if (h.isPlainObject(e)) {
                if (e["@context"]) {
                    var i = e["@context"];
                    if (Array.isArray(i)) for (var n = 0; n < i.length; n++) if ("string" == typeof i[n] && (/^http:\/\/iiif\.io\/api\/image\/[1-3]\/context\.json$/.test(i[n]) || "http://library.stanford.edu/iiif/image-api/1.1/context.json" === i[n])) {
                        i = i[n];
                        break
                    }
                    switch (i) {
                ...
                !e["@id"] && e.id && (e["@id"] = e.id);
                if (e.preferredFormats) for (var o = 0; o < e.preferredFormats.length; o++) if (OpenSeadragon.imageFormatSupported(e.preferredFormats[o])) {
            ...
            var r = function (e) {
                ...
                var t = e.documentElement, i = t.tagName, n = null;
                if ("info" == i) try {
                    !function e(t, i, n) {
                        var o, r;
                        if (3 == t.nodeType && n) {
            ...
            r["@context"] = "http://iiif.io/api/image/1.0/context.json";
            r["@id"] = t.replace("/info.xml", "");
            r.version = 1;
            return r
        }, getTileWidth: function (e) {
            ...
            if (this.emulateLegacyImagePyramid) {
                var t = NaN;
                0 < this.levels.length && e >= this.minLevel && e <= this.maxLevel && (t = this.levels[e].width / this.levels[this.maxLevel].width);
                return t
            }
            ...
            if (this.emulateLegacyImagePyramid) {
                var n = null;
                0 < this.levels.length && e >= this.minLevel && e <= this.maxLevel && (n = this.levels[e].url);
                return n
            }
            var o, r, s, a, l, h, c, u, d, p, g, m, v, f = Math.pow(.5, this.maxLevel - e),
                w = Math.ceil(this.width * f), y = Math.ceil(this.height * f);
            o = this.getTileWidth(e);
            r = this.getTileHeight(e);
            s = Math.ceil(o / f);
            a = Math.ceil(r / f);
            v = 1 === this.version ? "native." + this.tileFormat : "default." + this.tileFormat;
            if (w < o && y < r) {
                p = 2 === this.version && w === this.width || 3 === this.version && w === this.width && y === this.height ? "max" : 3 === this.version ? w + "," + y : w + ",";
                l = "full"
            } else {
                h = t * s;
                c = i * a;
                ...
                l = 0 === t && 0 === i && u === this.width && d === this.height ? "full" : [h, c, u, d].join(",");
                g = Math.ceil(u * f);
                m = Math.ceil(d * f);
                p = 2 === this.version && g === this.width || 3 === this.version && g === this.width && m === this.height ? "max" : 3 === this.version ? g + "," + m : g + ","
            }
            return [this["@id"], l, p, "0", v].join("/")
    ...
    function c(e) {
        ...
        var n = !1;
        2 === e.version && 1 < e.profile.length && e.profile[1].supports && (n = -1 !== e.profile[1].supports.indexOf("sizeByW"));
        3 === e.version && e.extraFeatures && (n = -1 !== e.extraFeatures.indexOf("sizeByWh"));
        return !i || n
    }
...
!function (l) {
    l.LegacyTileSource = function (e) {
        var t, i, n;
        l.isArray(e) && (t = {type: "legacy-image-pyramid", levels: e});
        t.levels = function (e) {
            var t, i, n = [];
            ...
            }) : l.console.error("Unsupported image format: %s", t.url ? t.url : "<no URL>");
        ...
        if (0 < t.levels.length) {
            ...
            n = i = 0;
            l.console.error("No supported image formats found")
        }
        l.extend(!0, t, {
            width: i,
            height: n,
        ...
        l.TileSource.apply(this, [t]);
        this.levels = t.levels
    };
    l.extend(l.LegacyTileSource.prototype, l.TileSource.prototype, {
        supports: function (e, t) {
            return e.type && "legacy-image-pyramid" == e.type || e.documentElement && "legacy-image-pyramid" == e.documentElement.getAttribute("type")
        }, configure: function (e, t) {
            return (l.isPlainObject(e) ? h : function (e, t) {
                if (!t || !t.documentElement) throw new Error(l.getString("Errors.Xml"));
                var i, n, o = t.documentElement, r = o.tagName, s = null, a = [];
                if ("image" == r) try {
                    s = {type: o.getAttribute("type"), levels: []};
                    a = o.getElementsByTagName("level");
                    ...
                    if ("collection" == r) throw new Error("Legacy Image Pyramid Collections not yet supported.");
                    if ("error" == r) throw new Error("Error: " + t)
                }
            ...
            return this.getLevelScale(e) ? new l.Point(1, 1) : new l.Point(0, 0)
        }, getTileUrl: function (e, t, i) {
            var n = null;
            0 < this.levels.length && e >= this.minLevel && e <= this.maxLevel && (n = this.levels[e].url);
            return n
...
!function (a) {
    ...
    a.extend(a.ImageTileSource.prototype, a.TileSource.prototype, {
        supports: function (e, t) {
            ...
            var t = NaN;
            e >= this.minLevel && e <= this.maxLevel && (t = this.levels[e].width / this.levels[this.maxLevel].width);
            return t
        }, getNumTiles: function (e) {
            return this.getLevelScale(e) ? new a.Point(1, 1) : new a.Point(0, 0)
        }, getTileUrl: function (e, t, i) {
            var n = null;
            e >= this.minLevel && e <= this.maxLevel && (n = this.levels[e].url);
            return n
        }, getContext2D: function (e, t, i) {
            var n = null;
            e >= this.minLevel && e <= this.maxLevel && (n = this.levels[e].context2D);
            return n
            ...
            var i = Object.prototype.hasOwnProperty.call(this._image, "naturalHeight") ? this._image.naturalHeight : this._image.height;
...
!function (o) {
    o.ButtonState = {REST: 0, GROUP: 1, HOVER: 2, DOWN: 3};
    o.Button = function (e) {
        var t = this;
        o.EventSource.call(this);
        o.extend(!0, this, {
            tooltip: null,
            srcRest: null,
            srcGroup: null,
        ...
        if (!e.element) {
            this.imgRest = o.makeTransparentImage(this.srcRest);
            this.imgGroup = o.makeTransparentImage(this.srcGroup);
            this.imgHover = o.makeTransparentImage(this.srcHover);
            ...
            o.Browser.vendor == o.BROWSERS.FIREFOX && o.Browser.version < 3 && (this.imgGroup.style.top = this.imgHover.style.top = this.imgDown.style.top = "");
        ...
        this.currentState = o.ButtonState.GROUP;
        ...
        this.tracker = new o.MouseTracker({
            ...
            enterHandler: function (e) {
                if (e.insideElementPressed) {
                    i(t, o.ButtonState.DOWN);
                    t.raiseEvent("enter", {originalEvent: e.originalEvent})
                } else e.buttonDownAny || i(t, o.ButtonState.HOVER)
            },
            ...
            releaseHandler: function (e) {
                if (e.insideElementPressed && e.insideElementReleased) {
                    n(t, o.ButtonState.HOVER);
                    t.raiseEvent("release", {originalEvent: e.originalEvent})
                } else e.insideElementPressed ? n(t, o.ButtonState.GROUP) : i(t, o.ButtonState.HOVER)
            },
        ...
        n(this, o.ButtonState.REST)
    };
    o.extend(o.Button.prototype, o.EventSource.prototype, {
        notifyGroupEnter: function () {
            i(this, o.ButtonState.GROUP)
        }, notifyGroupExit: function () {
            n(this, o.ButtonState.REST)
        }, disable: function () {
            this.notifyGroupExit();
            this.element.disabled = !0;
            o.setElementOpacity(this.element, .2, !0)
        }, enable: function () {
            this.element.disabled = !1;
            o.setElementOpacity(this.element, 1, !0);
        ...
        o.requestAnimationFrame(function () {
            !function (e) {
                ...
                if (e.shouldFade) {
                    ...
                    n = Math.min(1, n);
                    n = Math.max(0, n);
                    e.imgGroup && o.setElementOpacity(e.imgGroup, n, !0);
                    0 < n && r(e)
                }
            }(e)
        })
    ...
    function i(e, t) {
        if (!e.element.disabled) {
            if (t >= o.ButtonState.GROUP && e.currentState == o.ButtonState.REST) {
                !function (e) {
                    e.shouldFade = !1;
                    e.imgGroup && o.setElementOpacity(e.imgGroup, 1, !0)
                }(e);
                e.currentState = o.ButtonState.GROUP
            }
            if (t >= o.ButtonState.HOVER && e.currentState == o.ButtonState.GROUP) {
                e.imgHover && (e.imgHover.style.visibility = "");
                e.currentState = o.ButtonState.HOVER
            }
            if (t >= o.ButtonState.DOWN && e.currentState == o.ButtonState.HOVER) {
                e.imgDown && (e.imgDown.style.visibility = "");
                e.currentState = o.ButtonState.DOWN
            }
        }
    }
    ...
    function n(e, t) {
        if (!e.element.disabled) {
            if (t <= o.ButtonState.HOVER && e.currentState == o.ButtonState.DOWN) {
                e.imgDown && (e.imgDown.style.visibility = "hidden");
                e.currentState = o.ButtonState.HOVER
            }
            if (t <= o.ButtonState.GROUP && e.currentState == o.ButtonState.HOVER) {
                e.imgHover && (e.imgHover.style.visibility = "hidden");
                e.currentState = o.ButtonState.GROUP
            }
            if (t <= o.ButtonState.REST && e.currentState == o.ButtonState.GROUP) {
                !function (e) {
                    e.shouldFade = !0;
                    e.fadeBeginTime = o.now() + e.fadeDelay;
                    window.setTimeout(function () {
                        r(e)
                    }, e.fadeDelay)
                }(e);
                e.currentState = o.ButtonState.REST
            }
        }
    }
}(OpenSeadragon);
...
!function (R) {
    ...
    R.Rect.fromSummits = function (e, t, i) {
        var n = e.distanceTo(t);
        var o = e.distanceTo(i);
        var r = t.minus(e);
        var s = Math.atan(r.y / r.x);
        r.x < 0 ? s += Math.PI : r.y < 0 && (s += 2 * Math.PI);
        return new R.Rect(e.x, e.y, n, o, s / Math.PI * 180)
    };
    R.Rect.prototype = {
        clone: function () {
            return new R.Rect(this.x, this.y, this.width, this.height, this.degrees)
        }, getAspectRatio: function () {
            return this.width / this.height
        }, getTopLeft: function () {
            return new R.Point(this.x, this.y)
        }, getBottomRight: function () {
            return new R.Point(this.x + this.width, this.y + this.height).rotate(this.degrees, this.getTopLeft())
        }, getTopRight: function () {
            return new R.Point(this.x + this.width, this.y).rotate(this.degrees, this.getTopLeft())
        }, getBottomLeft: function () {
            return new R.Point(this.x, this.y + this.height).rotate(this.degrees, this.getTopLeft())
        }, getCenter: function () {
            return new R.Point(this.x + this.width / 2, this.y + this.height / 2).rotate(this.degrees, this.getTopLeft())
        }, getSize: function () {
            return new R.Point(this.width, this.height)
        }, equals: function (e) {
            return e instanceof R.Rect && this.x === e.x && this.y === e.y && this.width === e.width && this.height === e.height && this.degrees === e.degrees
        }, times: function (e) {
            return new R.Rect(this.x * e, this.y * e, this.width * e, this.height * e, this.degrees)
        }, translate: function (e) {
            return new R.Rect(this.x + e.x, this.y + e.y, this.width, this.height, this.degrees)
        }, union: function (e) {
            var t = this.getBoundingBox();
            var i = e.getBoundingBox();
            var n = Math.min(t.x, i.x);
            var o = Math.min(t.y, i.y);
            var r = Math.max(t.x + t.width, i.x + i.width);
            var s = Math.max(t.y + t.height, i.y + i.height);
            return new R.Rect(n, o, r - n, s - o)
        }, intersection: function (e) {
            var h = 1e-10;
            var t = [];
            var i = this.getTopLeft();
            e.containsPoint(i, h) && t.push(i);
            var n = this.getTopRight();
            e.containsPoint(n, h) && t.push(n);
            var o = this.getBottomLeft();
            e.containsPoint(o, h) && t.push(o);
            var r = this.getBottomRight();
            e.containsPoint(r, h) && t.push(r);
            var s = e.getTopLeft();
            this.containsPoint(s, h) && t.push(s);
            var a = e.getTopRight();
            this.containsPoint(a, h) && t.push(a);
            var l = e.getBottomLeft();
            this.containsPoint(l, h) && t.push(l);
            var c = e.getBottomRight();
            this.containsPoint(c, h) && t.push(c);
            var u = this._getSegments();
            var d = e._getSegments();
            for (var p = 0; p < u.length; p++) {
                var g = u[p];
                for (var m = 0; m < d.length; m++) {
                    var v = d[m];
                    var f = w(g[0], g[1], v[0], v[1]);
                    f && t.push(f)
                }
            }
            ...
            function w(e, t, i, n) {
                var o = t.minus(e);
                var r = n.minus(i);
                var s = -r.x * o.y + o.x * r.y;
                if (0 == s) return null;
                var a = (o.x * (e.y - i.y) - o.y * (e.x - i.x)) / s;
                var l = (r.x * (e.y - i.y) - r.y * (e.x - i.x)) / s;
                return -h <= a && a <= 1 - h && -h <= l && l <= 1 - h ? new R.Point(e.x + l * o.x, e.y + l * o.y) : null
            }
            ...
            if (0 === (e = R.positiveModulo(e, 360))) return this.clone();
            t = t || this.getCenter();
            var i = this.getTopLeft().rotate(e, t);
            var n = this.getTopRight().rotate(e, t).minus(i);
            n = n.apply(function (e) {
                return Math.abs(e) < 1e-15 ? 0 : e
            });
            var o = Math.atan(n.y / n.x);
            n.x < 0 ? o += Math.PI : n.y < 0 && (o += 2 * Math.PI);
            return new R.Rect(i.x, i.y, this.width, this.height, o / Math.PI * 180)
            ...
            var a = Math.max(e.y, t.y, i.y, n.y);
            return new R.Rect(o, s, r - o, a - s)
        }, getIntegerBoundingBox: function () {
            var e = this.getBoundingBox();
            var t = Math.floor(e.x);
            var i = Math.floor(e.y);
            var n = Math.ceil(e.width + e.x - t);
            var o = Math.ceil(e.height + e.y - i);
            return new R.Rect(t, i, n, o)
...
!function (d) {
    var s = {};
    d.ReferenceStrip = function (e) {
        var t, i, n, r = e.viewer, o = d.getElementSize(r.element);
        if (!e.id) {
            e.id = "referencestrip-" + d.now();
            this.element = d.makeNeutralElement("div");
            this.element.id = e.id;
            this.element.className = "referencestrip"
        }
        e = d.extend(!0, {
            sizeRatio: d.DEFAULT_SETTINGS.referenceStripSizeRatio,
            position: d.DEFAULT_SETTINGS.referenceStripPosition,
            scroll: d.DEFAULT_SETTINGS.referenceStripScroll,
            clickTimeThreshold: d.DEFAULT_SETTINGS.clickTimeThreshold
        }, e, {
            element: this.element,
            showNavigator: !1,
            mouseNavEnabled: !1,
        ...
        i.background = "#000";
        i.position = "relative";
        d.setElementTouchActionNone(this.element);
        d.setElementOpacity(this.element, .8);
        this.viewer = r;
        this.innerTracker = new d.MouseTracker({
            element: this.element,
            dragHandler: d.delegate(this, a),
            scrollHandler: d.delegate(this, l),
            enterHandler: d.delegate(this, c),
            exitHandler: d.delegate(this, u),
            keyDownHandler: d.delegate(this, p),
            keyHandler: d.delegate(this, g)
        });
        if (e.width && e.height) {
            this.element.style.width = e.width + "px";
            this.element.style.height = e.height + "px";
            r.addControl(this.element, {anchor: d.ControlAnchor.BOTTOM_LEFT})
        } else if ("horizontal" == e.scroll) {
            this.element.style.width = o.x * e.sizeRatio * r.tileSources.length + 12 * r.tileSources.length + "px";
            this.element.style.height = o.y * e.sizeRatio + "px";
            r.addControl(this.element, {anchor: d.ControlAnchor.BOTTOM_LEFT})
        } else {
            this.element.style.height = o.y * e.sizeRatio * r.tileSources.length + 12 * r.tileSources.length + "px";
            this.element.style.width = o.x * e.sizeRatio + "px";
            r.addControl(this.element, {anchor: d.ControlAnchor.TOP_LEFT})
        }
        ...
        for (n = 0; n < r.tileSources.length; n++) {
            (t = d.makeNeutralElement("div")).id = this.element.id + "-" + n;
            ...
            t.style.padding = "2px";
            d.setElementTouchActionNone(t);
            t.innerTracker = new d.MouseTracker({
                element: t,
                clickTimeThreshold: this.clickTimeThreshold,
                clickDistThreshold: this.clickDistThreshold,
                pressHandler: function (e) {
                    e.eventSource.dragging = d.now()
                },
                releaseHandler: function (e) {
                    var t = e.eventSource, i = t.element.id, n = Number(i.split("-")[2]), o = d.now();
                    if (e.insideElementPressed && e.insideElementReleased && t.dragging && o - t.dragging < t.clickTimeThreshold) {
                        t.dragging = null;
                        r.goToPage(n)
                    }
                }
        ...
        h(this, "vertical" == this.scroll ? o.y : o.x, 0);
        this.setFocus(0)
    };
    d.extend(d.ReferenceStrip.prototype, d.EventSource.prototype, d.Viewer.prototype, {
        setFocus: function (e) {
            var t, i = this.element.querySelector("#" + this.element.id + "-" + e),
                n = d.getElementSize(this.viewer.canvas), o = Number(this.element.style.width.replace("px", "")),
            ...
            if (this.currentSelected !== i) {
                ...
                this.currentPage = e;
                c.call(this, {eventSource: this.innerTracker})
            }
        }, update: function () {
            if (s[this.id].animating) {
                d.console.log("image reference strip update");
                return !0
            }
            return !1
        }, destroy: function () {
    ...
    function a(e) {
        var t = Number(this.element.style.marginLeft.replace("px", "")),
            ...
            o = Number(this.element.style.height.replace("px", "")), r = d.getElementSize(this.viewer.canvas);
        this.dragging = !0;
        if (this.element) if ("horizontal" == this.scroll) {
            if (0 < -e.delta.x) {
                if (t > -(n - r.x)) {
                    this.element.style.marginLeft = t + 2 * e.delta.x + "px";
                    h(this, r.x, t + 2 * e.delta.x)
                }
    ...
    function h(e, t, i) {
        ...
        o = Math.ceil(t / n) + 5;
        for (l = o = (o = (r = Math.ceil((Math.abs(i) + t) / n) + 1) - o) < 0 ? 0 : o; l < r && l < e.panels.length; l++) if (!(h = e.panels[l]).activePanel) {
            var c;
            var u = e.viewer.tileSources[l];
            c = u.referenceStripThumbnailUrl ? {type: "image", url: u.referenceStripThumbnailUrl} : u;
            (s = new d.Viewer({
                id: h.id,
                tileSources: [c],
                element: h,
            ...
            })).displayRegion = d.makeNeutralElement("div");
            s.displayRegion.id = h.id + "-displayregion";
            ...
            s.displayRegion.innerTracker = new d.MouseTracker({element: s.displayRegion, startDisabled: !0});
            h.getElementsByTagName("div")[0].appendChild(s.displayRegion);
            e.miniViewers[h.id] = s;
            h.activePanel = !0
        }
    }
    ...
    function c(e) {
        ...
        "horizontal" == this.scroll ? t.style.marginBottom = "0px" : t.style.marginLeft = "0px";
        return !1
    }

    function u(e) {
        var t = e.eventSource.element;
        "horizontal" == this.scroll ? t.style.marginBottom = "-" + d.getElementSize(t).y / 2 + "px" : t.style.marginLeft = "-" + d.getElementSize(t).x / 2 + "px";
        return !1
    }
    ...
    function p(e) {
        ...
        switch (e.keyCode) {
            case 38:
                l.call(this, {eventSource: this.tracker, position: null, scroll: 1, shift: null});
                return !1;
            case 40:
            case 37:
                l.call(this, {eventSource: this.tracker, position: null, scroll: -1, shift: null});
...
!function (s) {
    s.Spring = function (e) {
        ...
        s.console.assert("number" == typeof e.springStiffness && 0 !== e.springStiffness, "[OpenSeadragon.Spring] options.springStiffness must be a non-zero number");
        s.console.assert("number" == typeof e.animationTime && 0 <= e.animationTime, "[OpenSeadragon.Spring] options.animationTime must be a number greater than or equal to 0");
        if (e.exponential) {
            this._exponential = !0;
        ...
        s.console.assert(!this._exponential || 0 !== this.current.value, "[OpenSeadragon.Spring] value must be non-zero for exponential springs");
    ...
    s.Spring.prototype = {
        resetTo: function (e) {
            s.console.assert(!this._exponential || 0 !== e, "[OpenSeadragon.Spring.resetTo] target must be non-zero for exponential springs");
            this.start.value = this.target.value = this.current.value = e;
            this.start.time = this.target.time = this.current.time = s.now();
            if (this._exponential) {
                this.start._logValue = Math.log(this.start.value);
                this.target._logValue = Math.log(this.target.value);
                this.current._logValue = Math.log(this.current.value)
            ...
            s.console.assert(!this._exponential || 0 !== e, "[OpenSeadragon.Spring.springTo] target must be non-zero for exponential springs");
            ...
            this.target.value += e;
            if (this._exponential) {
                s.console.assert(0 !== this.target.value && 0 !== this.start.value, "[OpenSeadragon.Spring.shiftBy] spring value must be non-zero for exponential springs");
                this.start._logValue = Math.log(this.start.value);
                this.target._logValue = Math.log(this.target.value)
            }
            ...
            this._exponential = e;
            if (this._exponential) {
                s.console.assert(0 !== this.current.value && 0 !== this.target.value && 0 !== this.start.value, "[OpenSeadragon.Spring.setExponential] spring value must be non-zero for exponential springs");
                this.start._logValue = Math.log(this.start.value);
                this.target._logValue = Math.log(this.target.value);
                this.current._logValue = Math.log(this.current.value)
            }
        }, update: function () {
            this.current.time = s.now();
            var e, t;
            if (this._exponential) {
            ...
            var i = this.current.time >= this.target.time ? t : e + (t - e) * (n = this.springStiffness, o = (this.current.time - this.start.time) / (this.target.time - this.start.time), (1 - Math.exp(n * -o)) / (1 - Math.exp(-n)));
            var n, o;
            var r = this.current.value;
            this._exponential ? this.current.value = Math.exp(i) : this.current.value = i;
            return r != this.current.value
...
!function (t) {
    function n(e) {
        t.extend(!0, this, {timeout: t.DEFAULT_SETTINGS.timeout, jobId: null}, e);
        this.image = null
    }
    ...
    n.prototype = {
        errorMsg: null, start: function () {
            ...
            this.image.onabort = this.image.onerror = function () {
                r.errorMsg = "Image load aborted";
                r.finish(!1)
            };
            this.jobId = window.setTimeout(function () {
                r.errorMsg = "Image load exceeded timeout (" + r.timeout + " ms)";
                r.finish(!1)
            }, this.timeout);
            if (this.loadWithAjax) {
                this.request = t.makeAjaxRequest({
                    ...
                    success: function (t) {
                        ...
                        if (0 === i.size) {
                            r.errorMsg = "Empty image response.";
                            r.finish(!1)
                        }
...
!function (h) {
    h.Tile = function (e, t, i, n, o, r, s, a, l, h) {
        this.level = e;
        this.x = t;
        this.y = i;
        this.bounds = n;
    ...
    h.Tile.prototype = {
        toString: function () {
            ...
            if (this.cacheImageRecord) if (this.loaded) {
                ...
                h.setElementOpacity(this.element, this.opacity)
            } else h.console.warn("Attempting to draw tile %s when it's not yet loaded.", this.toString()); else h.console.warn("[Tile.drawHTML] attempting to draw tile %s when it's not cached", this.toString())
        }, drawCanvas: function (e, t, i, n) {
            var o, r = this.position.times(h.pixelDensityRatio), s = this.size.times(h.pixelDensityRatio);
            if (this.context2D || this.cacheImageRecord) {
                o = this.context2D || this.cacheImageRecord.getRenderedContext();
                if (this.loaded && o) {
                    e.save();
                    ...
                    n instanceof h.Point && (r = r.plus(n));
                    1 === e.globalAlpha && this._hasTransparencyChannel() && e.clearRect(r.x, r.y, s.x, s.y);
                    t({context: e, tile: this, rendered: o});
                    var a, l;
                    if (this.sourceBounds) {
                        a = Math.min(this.sourceBounds.width, o.canvas.width);
                        l = Math.min(this.sourceBounds.height, o.canvas.height)
                    } else {
                        a = o.canvas.width;
                        l = o.canvas.height
                    }
                    e.drawImage(o.canvas, 0, 0, a, l, r.x, r.y, s.x, s.y);
                    e.restore()
                } else h.console.warn("Attempting to draw tile %s when it's not yet loaded.", this.toString())
            } else h.console.warn("[Tile.drawCanvas] attempting to draw tile %s when it's not cached", this.toString())
        }, getScaleForEdgeSmoothing: function () {
            var e;
            if (this.cacheImageRecord) e = this.cacheImageRecord.getRenderedContext(); else {
                if (!this.context2D) {
                    h.console.warn("[Tile.drawCanvas] attempting to get tile scale %s when tile's not cached", this.toString());
                    return 1
                }
                e = this.context2D
            }
            return e.canvas.width / (this.size.x * h.pixelDensityRatio)
        }, getTranslationForEdgeSmoothing: function (e, t, i) {
            var n = Math.max(1, Math.ceil((i.x - t.x) / 2));
            var o = Math.max(1, Math.ceil((i.y - t.y) / 2));
            return new h.Point(n, o).minus(this.position.times(h.pixelDensityRatio).times(e || 1).apply(function (e) {
                return e % 1
            }))
        }, unload: function () {
...
!function (c) {
    c.OverlayPlacement = c.Placement;
    c.OverlayRotationMode = c.freezeObject({NO_ROTATION: 1, EXACT: 2, BOUNDING_BOX: 3});
    c.Overlay = function (e, t, i) {
        var n;
        n = c.isPlainObject(e) ? e : {element: e, location: t, placement: i};
    ...
    c.Overlay.prototype = {
        _init: function (e) {
            ...
            this.placement = void 0 === e.placement ? c.Placement.TOP_LEFT : e.placement;
            ...
            this.rotationMode = e.rotationMode || c.OverlayRotationMode.EXACT;
            if (this.location instanceof c.Rect) {
                this.width = this.location.width;
                this.height = this.location.height;
                this.location = this.location.getTopLeft();
                this.placement = c.Placement.TOP_LEFT
            }
            this.scales = null !== this.width && null !== this.height;
            this.bounds = new c.Rect(this.location.x, this.location.y, this.width, this.height);
            this.position = this.location
        }, adjust: function (e, t) {
            var i = c.Placement.properties[this.placement];
            if (i) {
            ...
            var i = c.getCssPropertyWithVendorPrefix("transformOrigin");
            var n = c.getCssPropertyWithVendorPrefix("transform");
            if (i && n) {
                t[i] = "";
                t[n] = ""
            }
            ...
            if (i.parentNode !== e) {
                ...
                e.appendChild(i);
                this.style.position = "absolute";
                this.size = c.getElementSize(i)
            }
            var n = this._getOverlayPositionAndSize(t);
            var o = n.position;
            var r = this.size = n.size;
            var s = n.rotate;
            if (this.onDraw) this.onDraw(o, r, this.element); else {
                var a = this.style;
                a.left = o.x + "px";
                a.top = o.y + "px";
                null !== this.width && (a.width = r.x + "px");
                null !== this.height && (a.height = r.y + "px");
                var l = c.getCssPropertyWithVendorPrefix("transformOrigin");
                var h = c.getCssPropertyWithVendorPrefix("transform");
                if (l && h) if (s) {
                    a[l] = this._getTransformOrigin();
                    a[h] = "rotate(" + s + "deg)"
                } else {
                    a[l] = "";
                    a[h] = ""
            ...
            this.adjust(t, i);
            var n = 0;
            if (e.degrees && this.rotationMode !== c.OverlayRotationMode.NO_ROTATION) if (this.rotationMode === c.OverlayRotationMode.BOUNDING_BOX && null !== this.width && null !== this.height) {
                var o = new c.Rect(t.x, t.y, i.x, i.y);
                var r = this._getBoundingBox(o, e.degrees);
                t = r.getTopLeft();
                i = r.getSize()
            } else n = e.degrees;
            ...
            if (null !== this.width || null !== this.height) {
                var n = e.deltaPixelsFromPointsNoRotate(new c.Point(this.width || 0, this.height || 0), !0);
                null !== this.width && (t = n.x);
                null !== this.height && (i = n.y)
            }
            if (this.checkResize && (null === this.width || null === this.height)) {
                var o = this.size = c.getElementSize(this.element);
                null === this.width && (t = o.x);
                null === this.height && (i = o.y)
            }
            return new c.Point(t, i)
            ...
            var e = "";
            var t = c.Placement.properties[this.placement];
            if (!t) return e;
            t.isLeft ? e = "left" : t.isRight && (e = "right");
            t.isTop ? e += " top" : t.isBottom && (e += " bottom");
            return e
        }, update: function (e, t) {
            var i = c.isPlainObject(e) ? e : {location: e, placement: t};
            this._init({
            ...
            c.console.assert(e, "A viewport must now be passed to Overlay.getBounds.");
            var t = this.width;
            var i = this.height;
            if (null === t || null === i) {
            ...
            this.adjust(o, new c.Point(t, i));
            return this._adjustBoundsForRotation(e, new c.Rect(o.x, o.y, t, i))
        }, _adjustBoundsForRotation: function (e, t) {
            if (!e || 0 === e.degrees || this.rotationMode === c.OverlayRotationMode.EXACT) return t;
            if (this.rotationMode !== c.OverlayRotationMode.BOUNDING_BOX) return t.rotate(-e.degrees, this._getPlacementPoint(t));
            if (null === this.width || null === this.height) return t;
            var i = this._getOverlayPositionAndSize(e);
            return e.viewerElementToViewportRectangle(new c.Rect(i.position.x, i.position.y, i.size.x, i.size.y))
        }
    }
}(OpenSeadragon);
!function (u) {
    u.Drawer = function (e) {
        u.console.assert(e.viewer, "[Drawer] options.viewer is required");
        var t = arguments;
        u.isPlainObject(e) || (e = {source: t[0], viewport: t[1], element: t[2]});
        u.console.assert(e.viewport, "[Drawer] options.viewport is required");
        u.console.assert(e.element, "[Drawer] options.element is required");
        e.source && u.console.error("[Drawer] options.source is no longer accepted; use TiledImage instead");
        this.viewer = e.viewer;
        this.viewport = e.viewport;
        this.debugGridColor = "string" == typeof e.debugGridColor ? [e.debugGridColor] : e.debugGridColor || u.DEFAULT_SETTINGS.debugGridColor;
        e.opacity && u.console.error("[Drawer] options.opacity is no longer accepted; set the opacity on the TiledImage instead");
        this.useCanvas = u.supportsCanvas && (!this.viewer || this.viewer.useCanvas);
        this.container = u.getElement(e.element);
        this.canvas = u.makeNeutralElement(this.useCanvas ? "canvas" : "div");
        ...
        u.setElementOpacity(this.canvas, this.opacity, !0);
    ...
    u.Drawer.prototype = {
        addOverlay: function (e, t, i, n) {
            u.console.error("drawer.addOverlay is deprecated. Use viewer.addOverlay instead.");
            this.viewer.addOverlay(e, t, i, n);
            return this
        }, updateOverlay: function (e, t, i) {
            u.console.error("drawer.updateOverlay is deprecated. Use viewer.updateOverlay instead.");
            this.viewer.updateOverlay(e, t, i);
            return this
        }, removeOverlay: function (e) {
            u.console.error("drawer.removeOverlay is deprecated. Use viewer.removeOverlay instead.");
            this.viewer.removeOverlay(e);
            return this
        }, clearOverlays: function () {
            u.console.error("drawer.clearOverlays is deprecated. Use viewer.clearOverlays instead.");
            this.viewer.clearOverlays();
            return this
        }, viewportCoordToDrawerCoord: function (e) {
            var t = this.viewport.pixelFromPointNoRotate(e, !0);
            return new u.Point(t.x * u.pixelDensityRatio, t.y * u.pixelDensityRatio)
            ...
            u.console.error("drawer.setOpacity is deprecated. Use tiledImage.setOpacity instead.");
            var t = this.viewer.world;
            for (var i = 0; i < t.getItemCount(); i++) t.getItemAt(i).setOpacity(e);
            return this
        }, getOpacity: function () {
            u.console.error("drawer.getOpacity is deprecated. Use tiledImage.getOpacity instead.");
            ...
            u.console.error("[Drawer.needsUpdate] this function is deprecated. Use World.needsDraw instead.");
            return this.viewer.world.needsDraw()
        }, numTilesLoaded: function () {
            u.console.error("[Drawer.numTilesLoaded] this function is deprecated. Use TileCache.numTilesLoaded instead.");
            return this.viewer.tileCache.numTilesLoaded()
        }, reset: function () {
            u.console.error("[Drawer.reset] this function is deprecated. Use World.resetItems instead.");
            this.viewer.world.resetItems();
            return this
        }, update: function () {
            u.console.error("[Drawer.update] this function is deprecated. Use Drawer.clear and World.draw instead.");
            this.clear();
            ...
            if (this.useCanvas) {
                ...
                if (t) i.clearRect(t.x, t.y, t.width, t.height); else {
                    var n = i.canvas;
            ...
            var i = this.viewport.deltaPixelsFromPointsNoRotate(e.getSize(), !0);
            return new u.Rect(t.x * u.pixelDensityRatio, t.y * u.pixelDensityRatio, i.x * u.pixelDensityRatio, i.y * u.pixelDensityRatio)
        }, drawTile: function (e, t, i, n, o) {
            u.console.assert(e, "[Drawer.drawTile] tile is required");
            u.console.assert(t, "[Drawer.drawTile] drawingHandler is required");
            if (this.useCanvas) {
                var r = this._getContext(i);
                n = n || 1;
                e.drawCanvas(r, t, n, o)
            ...
            var o = e;
            u.isPlainObject(o) || (o = {opacity: e, scale: t, translate: i, compositeOperation: n});
            if (this.useCanvas && this.sketchCanvas) {
                ...
                if (r) {
                    ...
                    t = o.scale || 1;
                    var s = (i = o.translate) instanceof u.Point ? i : new u.Point(0, 0);
                    var a = 0;
                    var l = 0;
                    if (i) {
                        var h = this.sketchCanvas.width - this.canvas.width;
                        var c = this.sketchCanvas.height - this.canvas.height;
                        a = Math.round(h / 2);
                        l = Math.round(c / 2)
                    }
            ...
            if (this.useCanvas) {
                ...
                var r = this.context;
                r.save();
                r.lineWidth = 2 * u.pixelDensityRatio;
                r.font = "small-caps bold " + 13 * u.pixelDensityRatio + "px arial";
                r.strokeStyle = this.debugGridColor[o];
                r.fillStyle = this.debugGridColor[o];
                0 !== this.viewport.degrees && this._offsetForRotation({degrees: this.viewport.degrees});
                ...
                r.strokeRect(e.position.x * u.pixelDensityRatio, e.position.y * u.pixelDensityRatio, e.size.x * u.pixelDensityRatio, e.size.y * u.pixelDensityRatio);
                var s = (e.position.x + e.size.x / 2) * u.pixelDensityRatio;
                var a = (e.position.y + e.size.y / 2) * u.pixelDensityRatio;
                r.translate(s, a);
                r.rotate(Math.PI / 180 * -this.viewport.degrees);
                r.translate(-s, -a);
                if (0 === e.x && 0 === e.y) {
                    r.fillText("Zoom: " + this.viewport.getZoom(), e.position.x * u.pixelDensityRatio, (e.position.y - 30) * u.pixelDensityRatio);
                    r.fillText("Pan: " + this.viewport.getBounds().toString(), e.position.x * u.pixelDensityRatio, (e.position.y - 20) * u.pixelDensityRatio)
                }
                r.fillText("Level: " + e.level, (e.position.x + 10) * u.pixelDensityRatio, (e.position.y + 20) * u.pixelDensityRatio);
                r.fillText("Column: " + e.x, (e.position.x + 10) * u.pixelDensityRatio, (e.position.y + 30) * u.pixelDensityRatio);
                r.fillText("Row: " + e.y, (e.position.x + 10) * u.pixelDensityRatio, (e.position.y + 40) * u.pixelDensityRatio);
                r.fillText("Order: " + i + " of " + t, (e.position.x + 10) * u.pixelDensityRatio, (e.position.y + 50) * u.pixelDensityRatio);
                r.fillText("Size: " + e.size.toString(), (e.position.x + 10) * u.pixelDensityRatio, (e.position.y + 60) * u.pixelDensityRatio);
                r.fillText("Position: " + e.position.toString(), (e.position.x + 10) * u.pixelDensityRatio, (e.position.y + 70) * u.pixelDensityRatio);
            ...
            if (this.useCanvas) {
                var t = this.context;
                t.save();
                t.lineWidth = 2 * u.pixelDensityRatio;
                t.strokeStyle = this.debugGridColor[0];
                t.fillStyle = this.debugGridColor[0];
                t.strokeRect(e.x * u.pixelDensityRatio, e.y * u.pixelDensityRatio, e.width * u.pixelDensityRatio, e.height * u.pixelDensityRatio);
                t.restore()
            }
            ...
            return new u.Point(t.width, t.height)
        }, getCanvasCenter: function () {
            return new u.Point(this.canvas.width / 2, this.canvas.height / 2)
        }, _offsetForRotation: function (e) {
            var t = e.point ? e.point.times(u.pixelDensityRatio) : this.getCanvasCenter();
            ...
            var t = (e = e || {}).point ? e.point.times(u.pixelDensityRatio) : this.getCanvasCenter();
            var i = this._getContext(e.useSketch);
            i.translate(t.x, 0);
            i.scale(-1, 1);
            i.translate(-t.x, 0)
...
!function (p) {
    p.Viewport = function (e) {
        var t = arguments;
        t.length && t[0] instanceof p.Point && (e = {containerSize: t[0], contentSize: t[1], config: t[2]});
        if (e.config) {
            p.extend(!0, e, e.config);
            delete e.config
        }
        this._margins = p.extend({left: 0, top: 0, right: 0, bottom: 0}, e.margins || {});
        delete e.margins;
        p.extend(!0, this, {
            containerSize: null,
            contentSize: null,
            zoomPoint: null,
            viewer: null,
            springStiffness: p.DEFAULT_SETTINGS.springStiffness,
            animationTime: p.DEFAULT_SETTINGS.animationTime,
            minZoomImageRatio: p.DEFAULT_SETTINGS.minZoomImageRatio,
            maxZoomPixelRatio: p.DEFAULT_SETTINGS.maxZoomPixelRatio,
            visibilityRatio: p.DEFAULT_SETTINGS.visibilityRatio,
            wrapHorizontal: p.DEFAULT_SETTINGS.wrapHorizontal,
            wrapVertical: p.DEFAULT_SETTINGS.wrapVertical,
            defaultZoomLevel: p.DEFAULT_SETTINGS.defaultZoomLevel,
            minZoomLevel: p.DEFAULT_SETTINGS.minZoomLevel,
            maxZoomLevel: p.DEFAULT_SETTINGS.maxZoomLevel,
            degrees: p.DEFAULT_SETTINGS.degrees,
            flipped: p.DEFAULT_SETTINGS.flipped,
            homeFillsViewer: p.DEFAULT_SETTINGS.homeFillsViewer
        }, e);
        this._updateContainerInnerSize();
        this.centerSpringX = new p.Spring({
            initial: 0,
            springStiffness: this.springStiffness,
            animationTime: this.animationTime
        });
        this.centerSpringY = new p.Spring({
            initial: 0,
            springStiffness: this.springStiffness,
            animationTime: this.animationTime
        });
        this.zoomSpring = new p.Spring({
            exponential: !0,
            initial: 1,
            springStiffness: this.springStiffness,
            animationTime: this.animationTime
        ...
        this._setContentBounds(new p.Rect(0, 0, 1, 1), 1);
        this.goHome(!0);
        this.update()
    };
    p.Viewport.prototype = {
        resetContentSize: function (e) {
            p.console.assert(e, "[Viewport.resetContentSize] contentSize is required");
            p.console.assert(e instanceof p.Point, "[Viewport.resetContentSize] contentSize must be an OpenSeadragon.Point");
            p.console.assert(0 < e.x, "[Viewport.resetContentSize] contentSize.x must be greater than 0");
            p.console.assert(0 < e.y, "[Viewport.resetContentSize] contentSize.y must be greater than 0");
            this._setContentBounds(new p.Rect(0, 0, 1, e.y / e.x), e.x);
            return this
        }, setHomeBounds: function (e, t) {
            p.console.error("[Viewport.setHomeBounds] this function is deprecated; The content bounds should not be set manually.");
            this._setContentBounds(e, t)
        }, _setContentBounds: function (e, t) {
            p.console.assert(e, "[Viewport._setContentBounds] bounds is required");
            p.console.assert(e instanceof p.Rect, "[Viewport._setContentBounds] bounds must be an OpenSeadragon.Rect");
            p.console.assert(0 < e.width, "[Viewport._setContentBounds] bounds.width must be greater than 0");
            p.console.assert(0 < e.height, "[Viewport._setContentBounds] bounds.height must be greater than 0");
            ...
            return new p.Rect(e.x - t / 2, e.y - i / 2, t, i)
        }, goHome: function (e) {
            ...
            return new p.Point(this.containerSize.x, this.containerSize.y)
        }, getMargins: function () {
            return p.extend({}, this._margins)
        }, setMargins: function (e) {
            p.console.assert("object" === p.type(e), "[Viewport.setMargins] margins must be an object");
            this._margins = p.extend({left: 0, top: 0, right: 0, bottom: 0}, e);
            this._updateContainerInnerSize();
            ...
            var n = i / this.getAspectRatio();
            return new p.Rect(t.x - i / 2, t.y - n / 2, i, n)
            ...
            var i = this._containerInnerSize.x * this.getZoom(e);
            ...
            var t, i, n, o, r, s, a = new p.Point(this.centerSpringX.current.value, this.centerSpringY.current.value),
                l = new p.Point(this.centerSpringX.target.value, this.centerSpringY.target.value);
            if (e) return a;
            if (!this.zoomPoint) return l;
            t = this.pixelFromPoint(this.zoomPoint, !0);
            o = (n = 1 / (i = this.getZoom())) / this.getAspectRatio();
            r = new p.Rect(a.x - n / 2, a.y - o / 2, n, o);
            s = this._pixelFromPoint(this.zoomPoint, r).minus(t).divide(this._containerInnerSize.x * i);
            return l.plus(s)
        }, getZoom: function (e) {
            ...
            var t = new p.Rect(e.x, e.y, e.width, e.height);
            if (!this.wrapHorizontal) {
                var i = this.visibilityRatio * t.width;
                var n = t.x + t.width;
                var o = this._contentBoundsNoRotate.x + this._contentBoundsNoRotate.width;
                var r = this._contentBoundsNoRotate.x - n + i;
                var s = o - t.x - i;
                i > this._contentBoundsNoRotate.width ? t.x += (r + s) / 2 : s < 0 ? t.x += s : 0 < r && (t.x += r)
            }
            if (!this.wrapVertical) {
                var a = this.visibilityRatio * t.height;
                var l = t.y + t.height;
                var h = this._contentBoundsNoRotate.y + this._contentBoundsNoRotate.height;
                var c = this._contentBoundsNoRotate.y - l + a;
                var u = h - t.y - a;
                a > this._contentBoundsNoRotate.height ? t.y += (c + u) / 2 : u < 0 ? t.y += u : 0 < c && (t.y += c)
            }
            return t
            ...
            var o = this._applyBoundaryConstraints(n);
            this._raiseConstraintsEvent(e);
            n.x === o.x && n.y === o.y && !e || this.fitBounds(o.rotate(-this.getRotation()), e);
            return this
            ...
            var r = e.getCenter();
            var s = new p.Rect(e.x, e.y, e.width, e.height, e.degrees + this.getRotation()).getBoundingBox();
            ...
            if (n) {
                ...
                var h = this._applyZoomConstraints(a);
                if (a !== h) {
                    a = h;
                    s.width = 1 / a;
                    s.x = r.x - s.width / 2;
                ...
                r = (s = this._applyBoundaryConstraints(s)).getCenter();
                this._raiseConstraintsEvent(i)
            }
            if (i) {
                this.panTo(r, !0);
                return this.zoomTo(a, null, !0)
            }
            this.panTo(this.getCenter(!0), !0);
            this.zoomTo(this.getZoom(!0), null, !0);
            var c = this.getBounds();
            var u = this.getZoom();
            if (0 === u || Math.abs(a / u - 1) < 1e-8) {
                this.zoomTo(a, !0);
                return this.panTo(r, i)
            }
            var d = (s = s.rotate(-this.getRotation())).getTopLeft().times(a).minus(c.getTopLeft().times(u)).divide(a - u);
            ...
            var t = new p.Rect(this._contentBounds.x + this._contentBounds.width / 2, this._contentBounds.y, 0, this._contentBounds.height);
            return this.fitBounds(t, e)
        }, fitHorizontally: function (e) {
            var t = new p.Rect(this._contentBounds.x, this._contentBounds.y + this._contentBounds.height / 2, this._contentBounds.width, 0);
            return this.fitBounds(t, e)
            ...
            var i = new p.Point(this.centerSpringX.target.value, this.centerSpringY.target.value);
            ...
            var n = this;
            this.zoomPoint = t instanceof p.Point && !isNaN(t.x) && !isNaN(t.y) ? t : null;
            ...
            this._containerInnerSize = new p.Point(Math.max(1, this.containerSize.x - (this._margins.left + this._margins.right)), Math.max(1, this.containerSize.y - (this._margins.top + this._margins.bottom)))
        }, update: function () {
            var e = this;
            ...
            if (this.zoomPoint) {
                ...
                var n = this.deltaPointsFromPixels(i, !0);
            ...
            return e.minus(t.getTopLeft()).times(this._containerInnerSize.x / t.width).plus(new p.Point(this._margins.left, this._margins.top))
            ...
            return e.minus(new p.Point(this._margins.left, this._margins.top)).divide(this._containerInnerSize.x / i.width).plus(i.getTopLeft())
            ...
            return new p.Point(e * this._contentSizeNoRotate.x / i, t * this._contentSizeNoRotate.x / i)
        }, viewportToImageCoordinates: function (e, t) {
            if (e instanceof p.Point) return this.viewportToImageCoordinates(e.x, e.y);
            if (this.viewer) {
                var i = this.viewer.world.getItemCount();
                if (1 < i) p.console.error("[Viewport.viewportToImageCoordinates] is not accurate with multi-image; use TiledImage.viewportToImageCoordinates instead."); else if (1 === i) {
            ...
            if (e instanceof p.Point) return this.imageToViewportCoordinates(e.x, e.y);
            if (this.viewer) {
                var i = this.viewer.world.getItemCount();
                if (1 < i) p.console.error("[Viewport.imageToViewportCoordinates] is not accurate with multi-image; use TiledImage.imageToViewportCoordinates instead."); else if (1 === i) {
                    return this.viewer.world.getItemAt(0).imageToViewportCoordinates(e, t, !0)
                }
            }
            var n = this._imageToViewportDelta(e, t);
            n.x += this._contentBoundsNoRotate.x;
            n.y += this._contentBoundsNoRotate.y;
            return n
        }, imageToViewportRectangle: function (e, t, i, n) {
            var o = e;
            o instanceof p.Rect || (o = new p.Rect(e, t, i, n));
            if (this.viewer) {
                var r = this.viewer.world.getItemCount();
                if (1 < r) p.console.error("[Viewport.imageToViewportRectangle] is not accurate with multi-image; use TiledImage.imageToViewportRectangle instead."); else if (1 === r) {
                    return this.viewer.world.getItemAt(0).imageToViewportRectangle(e, t, i, n, !0)
                }
            }
            var s = this.imageToViewportCoordinates(o.x, o.y);
            var a = this._imageToViewportDelta(o.width, o.height);
            return new p.Rect(s.x, s.y, a.x, a.y, o.degrees)
        }, viewportToImageRectangle: function (e, t, i, n) {
            var o = e;
            o instanceof p.Rect || (o = new p.Rect(e, t, i, n));
            if (this.viewer) {
                var r = this.viewer.world.getItemCount();
                if (1 < r) p.console.error("[Viewport.viewportToImageRectangle] is not accurate with multi-image; use TiledImage.viewportToImageRectangle instead."); else if (1 === r) {
                    return this.viewer.world.getItemAt(0).viewportToImageRectangle(e, t, i, n, !0)
                }
            }
            var s = this.viewportToImageCoordinates(o.x, o.y);
            var a = this._viewportToImageDelta(o.width, o.height);
            return new p.Rect(s.x, s.y, a.x, a.y, o.degrees)
            ...
            p.console.assert(this.viewer, "[Viewport.windowToImageCoordinates] the viewport must have a viewer.");
            var t = e.minus(p.getElementPosition(this.viewer.element));
            return this.viewerElementToImageCoordinates(t)
        }, imageToWindowCoordinates: function (e) {
            p.console.assert(this.viewer, "[Viewport.imageToWindowCoordinates] the viewport must have a viewer.");
            return this.imageToViewerElementCoordinates(e).plus(p.getElementPosition(this.viewer.element))
            ...
            return p.Rect.fromSummits(this.pointFromPixel(e.getTopLeft(), !0), this.pointFromPixel(e.getTopRight(), !0), this.pointFromPixel(e.getBottomLeft(), !0))
        }, viewportToViewerElementRectangle: function (e) {
            return p.Rect.fromSummits(this.pixelFromPoint(e.getTopLeft(), !0), this.pixelFromPoint(e.getTopRight(), !0), this.pixelFromPoint(e.getBottomLeft(), !0))
        }, windowToViewportCoordinates: function (e) {
            p.console.assert(this.viewer, "[Viewport.windowToViewportCoordinates] the viewport must have a viewer.");
            var t = e.minus(p.getElementPosition(this.viewer.element));
            return this.viewerElementToViewportCoordinates(t)
        }, viewportToWindowCoordinates: function (e) {
            p.console.assert(this.viewer, "[Viewport.viewportToWindowCoordinates] the viewport must have a viewer.");
            return this.viewportToViewerElementCoordinates(e).plus(p.getElementPosition(this.viewer.element))
        }, viewportToImageZoom: function (e) {
            if (this.viewer) {
                var t = this.viewer.world.getItemCount();
                if (1 < t) p.console.error("[Viewport.viewportToImageZoom] is not accurate with multi-image."); else if (1 === t) {
            ...
            if (this.viewer) {
                var t = this.viewer.world.getItemCount();
                if (1 < t) p.console.error("[Viewport.imageToViewportZoom] is not accurate with multi-image."); else if (1 === t) {
...
!function (y) {
    ...
    y.extend(y.TiledImage.prototype, y.EventSource.prototype, {
        needsDraw: function () {
            ...
            if (this._clip) {
                ...
                var n = this._clip.times(i);
                t = new y.Rect(t.x + n.x, t.y + n.y, n.width, n.height)
            }
            ...
            return new y.Point(e * (this.source.dimensions.x / n), t * (this.source.dimensions.y * this.contentAspectX / n))
            ...
            var s = this.imageToViewportCoordinates(r.getTopLeft(), o);
            var a = this._imageToViewportDelta(r.width, r.height, o);
            return new y.Rect(s.x, s.y, a.x, a.y, r.degrees + this.getRotation(o))
        }, viewportToImageRectangle: function (e, t, i, n, o) {
            var r = e;
            e instanceof y.Rect ? o = t : r = new y.Rect(e, t, i, n);
            var s = this.viewportToImageCoordinates(r.getTopLeft(), o);
            var a = this._viewportToImageDelta(r.width, r.height, o);
            return new y.Rect(s.x, s.y, a.x, a.y, r.degrees - this.getRotation(o))
        }, viewerElementToImageCoordinates: function (e) {
            ...
            function t(e) {
                return e.map(function (e) {
                    try {
                        if ((t = e) instanceof y.Point || "number" == typeof t.x && "number" == typeof t.y) return {
                            x: e.x,
                            y: e.y
                        };
                        throw new Error
            ...
            if (e.getAspectRatio() > o) {
                var h = e.height / l;
                var c = 0;
                n.isHorizontallyCentered ? c = (e.width - e.height * o) / 2 : n.isRight && (c = e.width - e.height * o);
                this.setPosition(new y.Point(e.x - r + c, e.y - s), i);
                this.setHeight(h, i)
            } else {
                var u = e.width / a;
                var d = 0;
                n.isVerticallyCentered ? d = (e.height - e.width / o) / 2 : n.isBottom && (d = e.height - e.width / o);
                this.setPosition(new y.Point(e.x - r, e.y - s + d), i);
                this.setWidth(u, i)
            }
        }, getClip: function () {
            ...
            var i = Math.min(Math.abs(this.source.maxLevel), Math.abs(Math.floor(Math.log(t / this.minPixelRatio) / Math.log(2))));
            i = Math.max(i, this.source.minLevel || 0);
            return {lowestLevel: e = Math.min(e, i), highestLevel: i}
        }, _updateViewport: function () {
            this._needsDraw = !1;
            this._tilesLoading = 0;
            this.loadingCoverage = {};
            for (; 0 < this.lastDrawn.length;) {
            ...
            var n = this._getLevelsInterval();
            var o = n.lowestLevel;
            var r = n.highestLevel;
            var s = null;
            var a = !1;
            var l = y.now();
            for (var h = r; o <= h; h--) {
                var c = !1;
                var u = e.deltaPixelsFromPointsNoRotate(this.source.getPixelRatio(h), !0).x * this._scaleSpring.current.value;
                if (h === o || !a && u >= this.minPixelRatio) a = c = !0; else if (!a) continue;
                var d = e.deltaPixelsFromPointsNoRotate(this.source.getPixelRatio(h), !1).x * this._scaleSpring.current.value;
                var p = e.deltaPixelsFromPointsNoRotate(this.source.getPixelRatio(Math.max(this.source.getClosestLevel(), 0)), !1).x * this._scaleSpring.current.value;
                var g = this.immediateRender ? 1 : p;
                s = m(this, a, c, h, Math.min(1, (u - .5) / .5), g / Math.abs(g - d), t, l, s);
                if (f(this.coverage, h)) break
            }
            !function (n, e) {
                if (0 === n.opacity || 0 === e.length && !n.placeholderFillStyle) return;
                var t = e[0];
                var i;
                t && (i = n.opacity < 1 || n.compositeOperation && "source-over" !== n.compositeOperation || !n._isBottomItem() && t._hasTransparencyChannel());
                var o;
                var r;
                var s = n.viewport.getZoom(!0);
                var a = n.viewportToImageZoom(s);
                if (1 < e.length && a > n.smoothTileEdgesMinZoom && !n.iOSDevice && n.getRotation(!0) % 360 == 0 && y.supportsCanvas) {
                    i = !0;
                    o = t.getScaleForEdgeSmoothing();
                    r = t.getTranslationForEdgeSmoothing(o, n._drawer.getCanvasSize(!1), n._drawer.getCanvasSize(!0))
                }
                var l;
                if (i) {
                    if (!o) {
                        l = n.viewport.viewportToViewerElementRectangle(n.getClippedBounds(!0)).getIntegerBoundingBox();
                        n._drawer.viewer.viewport.getFlip() && (0 === n.viewport.degrees && n.getRotation(!0) % 360 == 0 || (l.x = n._drawer.viewer.container.clientWidth - (l.x + l.width)));
                        l = l.times(y.pixelDensityRatio)
                    }
                    n._drawer._clear(!0, l)
                }
                if (!o) {
                    0 !== n.viewport.degrees && n._drawer._offsetForRotation({
                        degrees: n.viewport.degrees,
                        useSketch: i
                    });
                    n.getRotation(!0) % 360 != 0 && n._drawer._offsetForRotation({
                        degrees: n.getRotation(!0),
                        point: n.viewport.pixelFromPointNoRotate(n._getRotationPoint(!0), !0),
                        useSketch: i
                    });
                ...
                var h = !1;
                if (n._clip) {
                    n._drawer.saveContext(i);
                    var c = n.imageToViewportRectangle(n._clip, !0);
                    c = c.rotate(-n.getRotation(!0), n._getRotationPoint(!0));
                    var u = n._drawer.viewportToDrawerRectangle(c);
                    o && (u = u.times(o));
                    r && (u = u.translate(r));
                    n._drawer.setClip(u, i);
                    h = !0
                }
                if (n._croppingPolygons) {
                    n._drawer.saveContext(i);
                    try {
                        var d = n._croppingPolygons.map(function (e) {
                            return e.map(function (e) {
                                var t = n.imageToViewportCoordinates(e.x, e.y, !0).rotate(-n.getRotation(!0), n._getRotationPoint(!0));
                                var i = n._drawer.viewportCoordToDrawerCoord(t);
                                o && (i = i.times(o));
                                return i
                            })
                        });
                        n._drawer.clipWithPolygons(d, i)
                    } catch (e) {
                        y.console.error(e)
                    }
                    h = !0
                }
                if (n.placeholderFillStyle && !1 === n._hasOpaqueTile) {
                    var p = n._drawer.viewportToDrawerRectangle(n.getBounds(!0));
                    o && (p = p.times(o));
                    r && (p = p.translate(r));
                    var g = null;
                    g = "function" == typeof n.placeholderFillStyle ? n.placeholderFillStyle(n, n._drawer.context) : n.placeholderFillStyle;
                    n._drawer.drawRectangle(p, g, i)
                }
                for (var m = e.length - 1; 0 <= m; m--) {
                    t = e[m];
                    n._drawer.drawTile(t, n._drawingHandler, i, o, r);
                    t.beingDrawn = !0;
                    n.viewer && n.viewer.raiseEvent("tile-drawn", {tiledImage: n, tile: t})
                }
                h && n._drawer.restoreContext(i);
                if (!o) {
                    n.getRotation(!0) % 360 != 0 && n._drawer._restoreRotationChanges(i);
                    0 !== n.viewport.degrees && n._drawer._restoreRotationChanges(i)
                }
                if (i) {
                    if (o) {
                        0 !== n.viewport.degrees && n._drawer._offsetForRotation({
                    ...
                    n._drawer.blendSketch({
                        opacity: n.opacity,
                        scale: o,
                        translate: r,
                        compositeOperation: n.compositeOperation,
                        bounds: l
                    });
                    if (o) {
                        n.getRotation(!0) % 360 != 0 && n._drawer._restoreRotationChanges(!1);
                        0 !== n.viewport.degrees && n._drawer._restoreRotationChanges(!1)
                    }
                }
                o || 0 === n.viewport.degrees && n.getRotation(!0) % 360 == 0 && n._drawer.viewer.viewport.getFlip() && n._drawer._flip();
                !function (e, t) {
                    if (e.debugMode) for (var i = t.length - 1; 0 <= i; i--) {
                        var n = t[i];
                        try {
            ...
            if (s && !s.context2D) {
                !function (n, o, r) {
                    ...
                    n._imageLoader.addJob({
                        ...
                        ajaxHeaders: o.ajaxHeaders,
                        crossOriginPolicy: n.crossOriginPolicy,
                        ajaxWithCredentials: n.ajaxWithCredentials,
                        callback: function (e, t, i) {
                            !function (t, i, e, n, o, r) {
                                if (!n) {
                                    y.console.log("Tile %s failed to load: %s - error: %s", i, i.url, o);
                                ...
                                if (e < t.lastResetTime) {
                                    y.console.log("Ignoring tile %s loaded before reset: %s", i, i.url);
                                    i.loading = !1;
                                    return
                                }
            ...
            if (this.wrapVertical) {
                r = y.positiveModulo(t.y, a);
                s = y.positiveModulo(i.y, a)
            } else {
                r = Math.max(0, t.y);
                s = Math.min(a, i.y)
            }
            var l = this.source.getTileAtPoint(e, new y.Point(n, r));
            var h = this.source.getTileAtPoint(e, new y.Point(o, s));
            var c = this.source.getNumTiles(e);
            if (this.wrapHorizontal) {
                l.x += c.x * Math.floor(t.x);
                h.x += c.x * Math.floor(i.x)
            }
            if (this.wrapVertical) {
                l.y += c.y * Math.floor(t.y / a);
                h.y += c.y * Math.floor(i.y / a)
            }
            return {topLeft: l, bottomRight: h}
        }
    });

    function m(e, t, i, n, o, r, s, a, l) {
        var h = s.getBoundingBox().getTopLeft();
        var c = s.getBoundingBox().getBottomRight();
        ...
        S(e.coverage, n);
        S(e.loadingCoverage, n);
        var u = e._getCornerTiles(n, h, c);
        var d = u.topLeft;
        var p = u.bottomRight;
        var g = e.source.getNumTiles(n);
        var m = e.viewport.pixelFromPoint(e.viewport.getCenter());
        for (var v = d.x; v <= p.x; v++) for (var f = d.y; f <= p.y; f++) {
            if (!e.wrapHorizontal && !e.wrapVertical) {
                var w = e.source.getTileBounds(n, v, f);
                if (null === s.intersection(w)) continue
            }
            l = T(e, i, t, v, f, n, o, r, m, g, a, l)
        }
        return l
    }

    function T(e, t, i, n, o, r, s, a, l, h, c, u) {
        var d = function (e, t, i, n, o, r, s, a, l, h) {
            var c, u, d, p, g, m, v, f, w;
            r[i] || (r[i] = {});
            r[i][e] || (r[i][e] = {});
            if (!r[i][e][t]) {
                c = (a.x + e % a.x) % a.x;
                u = (a.y + t % a.y) % a.y;
                d = o.getTileBounds(i, c, u);
                p = o.getTileBounds(i, c, u, !0);
                g = o.tileExists(i, c, u);
                m = o.getTileUrl(i, c, u);
                if (n.loadTilesWithAjax) {
                    v = o.getTileAjaxHeaders(i, c, u);
                    y.isPlainObject(n.ajaxHeaders) && (v = y.extend({}, n.ajaxHeaders, v))
                } else v = null;
                f = o.getContext2D ? o.getContext2D(i, c, u) : void 0;
                d.x += (e - c) / a.x;
                d.y += h / l * ((t - u) / a.y);
                w = new y.Tile(i, e, t, d, g, m, f, n.loadTilesWithAjax, v, p);
                c == a.x - 1 && (w.isRightMost = !0);
                u == a.y - 1 && (w.isBottomMost = !0);
                r[i][e][t] = w
            }
            (w = r[i][e][t]).lastTouchTime = s;
            return w
        }(n, o, r, e, e.source, e.tilesMatrix, c, h, e._worldWidthCurrent, e._worldHeightCurrent), p = i;
        e.viewer && e.viewer.raiseEvent("update-tile", {tiledImage: e, tile: d});
        x(e.coverage, r, n, o, !1);
        var g = d.loaded || d.loading || w(e.loadingCoverage, r, n, o);
        x(e.loadingCoverage, r, n, o, g);
        if (!d.exists) return u;
        t && !p && (w(e.coverage, r, n, o) ? x(e.coverage, r, n, o, !0) : p = !0);
        if (!p) return u;
        !function (e, t, i, n, o, r) {
            var s = e.bounds.getTopLeft();
            s.x *= r._scaleSpring.current.value;
            s.y *= r._scaleSpring.current.value;
            s.x += r._xSpring.current.value;
            s.y += r._ySpring.current.value;
            var a = e.bounds.getSize();
            a.x *= r._scaleSpring.current.value;
            a.y *= r._scaleSpring.current.value;
            var l = i.pixelFromPointNoRotate(s, !0), h = i.pixelFromPointNoRotate(s, !1),
                c = i.deltaPixelsFromPointsNoRotate(a, !0), u = i.deltaPixelsFromPointsNoRotate(a, !1),
                d = h.plus(u.divide(2)), p = n.squaredDistanceTo(d);
            t || (c = c.plus(new y.Point(1, 1)));
            e.isRightMost && r.wrapHorizontal && (c.x += .75);
            e.isBottomMost && r.wrapVertical && (c.y += .75);
            e.position = l;
            e.size = c;
            e.squaredDistance = p;
            e.visibility = o
        }(d, e.source.tileOverlap, e.viewport, l, a, e);
        if (!d.loaded) if (d.context2D) v(e, d); else {
            var m = e._tileCache.getImageRecord(d.cacheKey);
            if (m) {
                v(e, d, m.getImage())
            }
        }
        if (d.loaded) {
            (function (e, t, i, n, o, r, s) {
                var a, l, h = 1e3 * e.blendTime;
                t.blendStart || (t.blendStart = s);
                a = s - t.blendStart;
                l = h ? Math.min(1, a / h) : 1;
                e.alwaysBlend && (l *= r);
                t.opacity = l;
                e.lastDrawn.push(t);
                if (1 === l) {
                    x(e.coverage, o, i, n, !0);
                    e._hasOpaqueTile = !0
                } else if (a < h) return !0;
                return !1
            })(e, d, n, o, r, s, c) && (e._needsDraw = !0)
        } else d.loading ? e._tilesLoading++ : g || (u = function (e, t) {
            if (!e) return t;
            {
    ...
    function f(e, t, i, n) {
        ...
        for (s in o) if (Object.prototype.hasOwnProperty.call(o, s)) {
            r = o[s];
            for (a in r) if (Object.prototype.hasOwnProperty.call(r, a) && !r[a]) return !1
        }
        return !0
    }

    function w(e, t, i, n) {
        return void 0 === i || void 0 === n ? f(e, t + 1) : f(e, t + 1, 2 * i, 2 * n) && f(e, t + 1, 2 * i, 2 * n + 1) && f(e, t + 1, 2 * i + 1, 2 * n) && f(e, t + 1, 2 * i + 1, 2 * n + 1)
    }
...
!function (g) {
    ...
    g.TileCache = function (e) {
        e = e || {};
        this._maxImageCacheCount = e.maxImageCacheCount || g.DEFAULT_SETTINGS.maxImageCacheCount;
        this._tilesLoaded = [];
        this._imagesLoaded = [];
    ...
    g.TileCache.prototype = {
        numTilesLoaded: function () {
            ...
            if (!n) {
                ...
                n = this._imagesLoaded[e.tile.cacheKey] = new v({image: e.image});
...
!function (v) {
    v.World = function (e) {
        var t = this;
        v.console.assert(e.viewer, "[World] options.viewer is required");
    ...
    v.extend(v.World.prototype, v.EventSource.prototype, {
        addItem: function (e, t) {
            v.console.assert(e, "[World.addItem] item is required");
            v.console.assert(e instanceof v.TiledImage, "[World.addItem] only TiledImages supported at this time");
            if (void 0 !== (t = t || {}).index) {
            ...
            v.console.assert(void 0 !== e, "[World.getItemAt] index is required");
            return this._items[e]
        }, getIndexOfItem: function (e) {
            v.console.assert(e, "[World.getIndexOfItem] item is required");
            return v.indexOf(this._items, e)
        }, getItemCount: function () {
            return this._items.length
        }, setItemIndex: function (e, t) {
            v.console.assert(e, "[World.setItemIndex] item is required");
            v.console.assert(void 0 !== t, "[World.setItemIndex] index is required");
            ...
            v.console.assert(e, "[World.removeItem] item is required");
            var t = v.indexOf(this._items, e);
            if (-1 !== t) {
            ...
            var i = e.layout || v.DEFAULT_SETTINGS.collectionLayout;
            var n = e.rows || v.DEFAULT_SETTINGS.collectionRows;
            var o = e.columns || v.DEFAULT_SETTINGS.collectionColumns;
            var r = e.tileSize || v.DEFAULT_SETTINGS.collectionTileSize;
            var s = r + (e.tileMargin || v.DEFAULT_SETTINGS.collectionTileMargin);
            var a;
            ...
            for (var m = 0; m < this._items.length; m++) {
                ...
                p = (d = (u = (c = this._items[m]).getBounds()).width > u.height ? r : r * (u.width / u.height)) * (u.height / u.width);
                g = new v.Point(l + (r - d) / 2, h + (r - p) / 2);
                c.setPosition(g, t);
                c.setWidth(d, t);
            ...
            if (this._items.length) {
                ...
                this._homeBounds = new v.Rect(s, a, l - s, h - a);
                this._contentSize = new v.Point(this._homeBounds.width * this._contentFactor, this._homeBounds.height * this._contentFactor)
            } else {
                this._homeBounds = new v.Rect(0, 0, 1, 1);
                this._contentSize = new v.Point(1, 1);
