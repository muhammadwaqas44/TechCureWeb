...
$('#vital_ft_2').on('click', function () {
    ...
    $('#height_ft_2').show();
    $('#height_ft_2').val(feet);
    $('#vital_cms_2').show();
    $('#height_in_2').show();
    $('#height_in_2').val(inches);
    $('#vital_ft_2').hide();
    $('#height_cms_2').hide();
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.result == 'success') {
                ...
                //                 <div class="lab-img">\
                //                 <img src="http://localhost/eon/storage/app/public/reportImages/L1aWsThnoCOdNvscdA2TBEGn7pCjRitDngKgIknw.webp" style="height: 90px;\
                //                 width: 131px;">\
                //                 <i class="fa fa-search"></i>\
                //                 </div>\
                //                 <p class="lab-rep m-0">Qaiser</p>\
                //                 <p class="rep-date m-0">07 Sep, 2020</p>\
                //                 </a>\
                //                 </div></div>';
                ...
                //             <div class="lab-img">\
                //                 <img src="http://localhost/eon/storage/app/public/reportImages/L1aWsThnoCOdNvscdA2TBEGn7pCjRitDngKgIknw.webp"\
                //                      style="height: 90px;\
                //                 width: 131px;">\
                //                 <i class="fa fa-search"></i>\
                //             </div>\
                //             <p class="lab-rep m-0">Testing</p>\
                //             <p class="rep-date m-0">07 Sep, 2020</p>\
                //         </a>\
                //     </div>';
